...
exports.grantRoleAndPauseToken = grantRoleAndPauseToken;
exports.assertObject = assertObject;
const chai_1 = require("chai");
async function grantRoleAndPauseToken(accessControlFacet, pauseFacet, role, signerAccessControl, signerPause, accountToAssignRole) {
...
function assertObject(actual, expected, path = '') {
    Object.keys(expected).forEach((key) => {
        ...
        if (typeof actualValue === 'object' &&
            ...
            (0, chai_1.expect)(actualValue).to.equal(expectedValue, `Found error on ${pathError}`);
        }
    });
}
