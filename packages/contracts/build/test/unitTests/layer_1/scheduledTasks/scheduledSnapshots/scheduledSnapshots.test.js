...
describe('Scheduled Snapshots Tests', () => {
    ...
    async function setFacets(diamond) {
        ...
        scheduledSnapshotsFacet = _typechain_1.ScheduledSnapshots__factory.connect(diamond.address, signer_A);
    ...
    it('GIVEN a token WHEN triggerSnapshots THEN transaction succeeds', async () => {
        ...
        // set dividend
        const dividendsRecordDateInSeconds_1 = (0, _scripts_1.dateToUnixTimestamp)('2030-01-01T00:00:06Z');
        const dividendsRecordDateInSeconds_2 = (0, _scripts_1.dateToUnixTimestamp)('2030-01-01T00:00:12Z');
        const dividendsRecordDateInSeconds_3 = (0, _scripts_1.dateToUnixTimestamp)('2030-01-01T00:00:18Z');
        const dividendsExecutionDateInSeconds = (0, _scripts_1.dateToUnixTimestamp)('2030-01-01T00:01:00Z');
        ...
        (0, chai_1.expect)(scheduledSnapshotCount).to.equal(3);
        (0, chai_1.expect)(scheduledSnapshots.length).to.equal(scheduledSnapshotCount);
        (0, chai_1.expect)(scheduledSnapshots[0].scheduledTimestamp.toNumber()).to.equal(dividendsRecordDateInSeconds_3);
        (0, chai_1.expect)(scheduledSnapshots[0].data).to.equal(dividend_3_Id);
        (0, chai_1.expect)(scheduledSnapshots[1].scheduledTimestamp.toNumber()).to.equal(dividendsRecordDateInSeconds_2);
        (0, chai_1.expect)(scheduledSnapshots[1].data).to.equal(dividend_2_Id);
        (0, chai_1.expect)(scheduledSnapshots[2].scheduledTimestamp.toNumber()).to.equal(dividendsRecordDateInSeconds_1);
        (0, chai_1.expect)(scheduledSnapshots[2].data).to.equal(dividend_1_Id);
        ...
        await (0, chai_1.expect)(scheduledTasksFacet.triggerPendingScheduledTasks())
        ...
        (0, chai_1.expect)(scheduledSnapshotCount).to.equal(2);
        (0, chai_1.expect)(scheduledSnapshots.length).to.equal(scheduledSnapshotCount);
        (0, chai_1.expect)(scheduledSnapshots[0].scheduledTimestamp.toNumber()).to.equal(dividendsRecordDateInSeconds_3);
        (0, chai_1.expect)(scheduledSnapshots[0].data).to.equal(dividend_3_Id);
        (0, chai_1.expect)(scheduledSnapshots[1].scheduledTimestamp.toNumber()).to.equal(dividendsRecordDateInSeconds_2);
        ...
        await (0, chai_1.expect)(scheduledTasksFacet.triggerScheduledTasks(100))
            .to.emit(scheduledSnapshotsFacet, 'SnapshotTriggered')
        ...
        scheduledSnapshots =
            await scheduledSnapshotsFacet.getScheduledSnapshots(0, 100);
        (0, chai_1.expect)(scheduledSnapshotCount).to.equal(1);
        (0, chai_1.expect)(scheduledSnapshots.length).to.equal(scheduledSnapshotCount);
        (0, chai_1.expect)(scheduledSnapshots[0].scheduledTimestamp.toNumber()).to.equal(dividendsRecordDateInSeconds_3);
        (0, chai_1.expect)(scheduledSnapshots[0].data).to.equal(dividend_3_Id);
        // AFTER SECOND SCHEDULED SNAPSHOTS ------------------------------------------------------------------
        await timeTravelFacet.changeSystemTimestamp(dividendsRecordDateInSeconds_3 + 1);
        await (0, chai_1.expect)(scheduledTasksFacet.triggerScheduledTasks(0))
            .to.emit(scheduledSnapshotsFacet, 'SnapshotTriggered')
        ...
        scheduledSnapshots =
            await scheduledSnapshotsFacet.getScheduledSnapshots(0, 100);
        (0, chai_1.expect)(scheduledSnapshotCount).to.equal(0);
        (0, chai_1.expect)(scheduledSnapshots.length).to.equal(scheduledSnapshotCount);
    });
});
