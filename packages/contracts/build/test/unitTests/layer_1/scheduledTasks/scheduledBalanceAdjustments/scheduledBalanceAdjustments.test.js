...
describe('Scheduled BalanceAdjustments Tests', () => {
    ...
    let equityFacet;
    let scheduledBalanceAdjustmentsFacet;
    ...
    async function setFacets(diamond) {
        ...
        equityFacet = _typechain_1.Equity__factory.connect(diamond.address, signer_A);
        scheduledBalanceAdjustmentsFacet =
            _typechain_1.ScheduledBalanceAdjustments__factory.connect(diamond.address, signer_A);
    ...
    it('GIVEN a token WHEN triggerBalanceAdjustments THEN transaction succeeds', async () => {
        ...
        const balanceAdjustmentExecutionDateInSeconds_1 = (0, _scripts_1.dateToUnixTimestamp)('2030-01-01T00:00:06Z');
        const balanceAdjustmentExecutionDateInSeconds_2 = (0, _scripts_1.dateToUnixTimestamp)('2030-01-01T00:00:12Z');
        const balanceAdjustmentExecutionDateInSeconds_3 = (0, _scripts_1.dateToUnixTimestamp)('2030-01-01T00:00:18Z');
        ...
        (0, chai_1.expect)(scheduledBalanceAdjustmentCount).to.equal(3);
        (0, chai_1.expect)(scheduledBalanceAdjustments.length).to.equal(scheduledBalanceAdjustmentCount);
        (0, chai_1.expect)(scheduledBalanceAdjustments[0].scheduledTimestamp.toNumber()).to.equal(balanceAdjustmentExecutionDateInSeconds_3);
        (0, chai_1.expect)(scheduledBalanceAdjustments[0].data).to.equal(balanceAdjustment_3_Id);
        (0, chai_1.expect)(scheduledBalanceAdjustments[1].scheduledTimestamp.toNumber()).to.equal(balanceAdjustmentExecutionDateInSeconds_2);
        (0, chai_1.expect)(scheduledBalanceAdjustments[1].data).to.equal(balanceAdjustment_2_Id);
        (0, chai_1.expect)(scheduledBalanceAdjustments[2].scheduledTimestamp.toNumber()).to.equal(balanceAdjustmentExecutionDateInSeconds_1);
        (0, chai_1.expect)(scheduledBalanceAdjustments[2].data).to.equal(balanceAdjustment_1_Id);
        ...
        scheduledBalanceAdjustments =
            await scheduledBalanceAdjustmentsFacet.getScheduledBalanceAdjustments(0, 100);
        (0, chai_1.expect)(scheduledBalanceAdjustmentCount).to.equal(2);
        (0, chai_1.expect)(scheduledBalanceAdjustments.length).to.equal(scheduledBalanceAdjustmentCount);
        (0, chai_1.expect)(scheduledBalanceAdjustments[0].scheduledTimestamp.toNumber()).to.equal(balanceAdjustmentExecutionDateInSeconds_3);
        (0, chai_1.expect)(scheduledBalanceAdjustments[0].data).to.equal(balanceAdjustment_3_Id);
        (0, chai_1.expect)(scheduledBalanceAdjustments[1].scheduledTimestamp.toNumber()).to.equal(balanceAdjustmentExecutionDateInSeconds_2);
        ...
        scheduledBalanceAdjustments =
            await scheduledBalanceAdjustmentsFacet.getScheduledBalanceAdjustments(0, 100);
        (0, chai_1.expect)(scheduledBalanceAdjustmentCount).to.equal(1);
        (0, chai_1.expect)(scheduledBalanceAdjustments.length).to.equal(scheduledBalanceAdjustmentCount);
        (0, chai_1.expect)(scheduledBalanceAdjustments[0].scheduledTimestamp.toNumber()).to.equal(balanceAdjustmentExecutionDateInSeconds_3);
        (0, chai_1.expect)(scheduledBalanceAdjustments[0].data).to.equal(balanceAdjustment_3_Id);
        ...
        scheduledBalanceAdjustments =
            await scheduledBalanceAdjustmentsFacet.getScheduledBalanceAdjustments(0, 100);
        (0, chai_1.expect)(scheduledBalanceAdjustmentCount).to.equal(0);
        (0, chai_1.expect)(scheduledBalanceAdjustments.length).to.equal(scheduledBalanceAdjustmentCount);
    });
});
