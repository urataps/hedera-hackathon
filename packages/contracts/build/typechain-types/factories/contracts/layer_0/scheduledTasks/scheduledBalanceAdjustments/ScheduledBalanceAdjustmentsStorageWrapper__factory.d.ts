...
import type { ScheduledBalanceAdjustmentsStorageWrapper, ScheduledBalanceAdjustmentsStorageWrapperInterface } from "../../../../../contracts/layer_0/scheduledTasks/scheduledBalanceAdjustments/ScheduledBalanceAdjustmentsStorageWrapper";
export declare class ScheduledBalanceAdjustmentsStorageWrapper__factory {
    ...
    static createInterface(): ScheduledBalanceAdjustmentsStorageWrapperInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): ScheduledBalanceAdjustmentsStorageWrapper;
}
