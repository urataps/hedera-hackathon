...
import type { ScheduledTasksStorageWrapper, ScheduledTasksStorageWrapperInterface } from "../../../../../contracts/layer_0/scheduledTasks/scheduledTasks/ScheduledTasksStorageWrapper";
export declare class ScheduledTasksStorageWrapper__factory {
    ...
    static createInterface(): ScheduledTasksStorageWrapperInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): ScheduledTasksStorageWrapper;
}
