...
import type { ScheduledSnapshotsStorageWrapperRead, ScheduledSnapshotsStorageWrapperReadInterface } from "../../../../../contracts/layer_0/scheduledTasks/scheduledSnapshots/ScheduledSnapshotsStorageWrapperRead";
export declare class ScheduledSnapshotsStorageWrapperRead__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): ScheduledSnapshotsStorageWrapperRead;
}
