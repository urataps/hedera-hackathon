...
import type { ScheduledTasksCommon, ScheduledTasksCommonInterface } from "../../../../contracts/layer_0/scheduledTasks/ScheduledTasksCommon";
export declare class ScheduledTasksCommon__factory {
    ...
    static createInterface(): ScheduledTasksCommonInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): ScheduledTasksCommon;
}
