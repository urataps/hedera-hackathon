...
import type { SecurityStorageWrapper, SecurityStorageWrapperInterface } from "../../../../contracts/layer_0/security/SecurityStorageWrapper";
type SecurityStorageWrapperConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;
export declare class SecurityStorageWrapper__factory extends ContractFactory {
    constructor(...args: SecurityStorageWrapperConstructorParams);
    deploy(overrides?: Overrides & {
        from?: PromiseOrValue<string>;
    }): Promise<SecurityStorageWrapper>;
    getDeployTransaction(overrides?: Overrides & {
        from?: PromiseOrValue<string>;
    }): TransactionRequest;
    attach(address: string): SecurityStorageWrapper;
    connect(signer: Signer): SecurityStorageWrapper__factory;
    static readonly bytecode = "0x6080604052348015600f57600080fd5b50603f80601d6000396000f3fe6080604052600080fdfea2646970667358221220c9cce9a2c862298036b103ea2f52493c031907fc02e5321dd3c07d3bc0db750c64736f6c63430008120033";
    ...
    static createInterface(): SecurityStorageWrapperInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): SecurityStorageWrapper;
}
export {};
