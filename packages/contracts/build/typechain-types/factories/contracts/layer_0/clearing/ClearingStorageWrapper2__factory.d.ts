...
import type { ClearingStorageWrapper2, ClearingStorageWrapper2Interface } from "../../../../contracts/layer_0/clearing/ClearingStorageWrapper2";
export declare class ClearingStorageWrapper2__factory {
    ...
    static createInterface(): ClearingStorageWrapper2Interface;
    static connect(address: string, signerOrProvider: Signer | Provider): ClearingStorageWrapper2;
}
