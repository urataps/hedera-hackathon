...
import type { ClearingStorageWrapper1, ClearingStorageWrapper1Interface } from "../../../../contracts/layer_0/clearing/ClearingStorageWrapper1";
export declare class ClearingStorageWrapper1__factory {
    ...
    static createInterface(): ClearingStorageWrapper1Interface;
    static connect(address: string, signerOrProvider: Signer | Provider): ClearingStorageWrapper1;
}
