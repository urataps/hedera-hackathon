...
import type { EquityStorageWrapper, EquityStorageWrapperInterface } from "../../../../contracts/layer_0/equity/EquityStorageWrapper";
export declare class EquityStorageWrapper__factory {
    ...
    static createInterface(): EquityStorageWrapperInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): EquityStorageWrapper;
}
