...
import type { LockStorageWrapper1, LockStorageWrapper1Interface } from "../../../../contracts/layer_0/lock/LockStorageWrapper1";
export declare class LockStorageWrapper1__factory {
    ...
    static createInterface(): LockStorageWrapper1Interface;
    static connect(address: string, signerOrProvider: Signer | Provider): LockStorageWrapper1;
}
