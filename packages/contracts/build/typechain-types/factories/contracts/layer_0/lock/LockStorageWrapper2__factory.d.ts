...
import type { LockStorageWrapper2, LockStorageWrapper2Interface } from "../../../../contracts/layer_0/lock/LockStorageWrapper2";
export declare class LockStorageWrapper2__factory {
    ...
    static createInterface(): LockStorageWrapper2Interface;
    static connect(address: string, signerOrProvider: Signer | Provider): LockStorageWrapper2;
}
