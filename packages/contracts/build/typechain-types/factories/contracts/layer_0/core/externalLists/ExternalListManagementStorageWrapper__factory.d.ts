...
import type { ExternalListManagementStorageWrapper, ExternalListManagementStorageWrapperInterface } from "../../../../../contracts/layer_0/core/externalLists/ExternalListManagementStorageWrapper";
export declare class ExternalListManagementStorageWrapper__factory {
    ...
    static createInterface(): ExternalListManagementStorageWrapperInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): ExternalListManagementStorageWrapper;
}
