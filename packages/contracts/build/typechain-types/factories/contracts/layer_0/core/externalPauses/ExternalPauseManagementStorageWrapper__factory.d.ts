...
import type { ExternalPauseManagementStorageWrapper, ExternalPauseManagementStorageWrapperInterface } from "../../../../../contracts/layer_0/core/externalPauses/ExternalPauseManagementStorageWrapper";
export declare class ExternalPauseManagementStorageWrapper__factory {
    ...
    static createInterface(): ExternalPauseManagementStorageWrapperInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): ExternalPauseManagementStorageWrapper;
}
