...
import type { SsiManagementStorageWrapper, SsiManagementStorageWrapperInterface } from "../../../../../contracts/layer_0/core/ssi/SsiManagementStorageWrapper";
export declare class SsiManagementStorageWrapper__factory {
    ...
    static createInterface(): SsiManagementStorageWrapperInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): SsiManagementStorageWrapper;
}
