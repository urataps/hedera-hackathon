...
import type { PauseStorageWrapper, PauseStorageWrapperInterface } from "../../../../../contracts/layer_0/core/pause/PauseStorageWrapper";
export declare class PauseStorageWrapper__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): PauseStorageWrapper;
}
