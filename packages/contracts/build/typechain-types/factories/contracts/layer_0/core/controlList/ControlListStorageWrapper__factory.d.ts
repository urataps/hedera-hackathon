...
import type { ControlListStorageWrapper, ControlListStorageWrapperInterface } from "../../../../../contracts/layer_0/core/controlList/ControlListStorageWrapper";
export declare class ControlListStorageWrapper__factory {
    ...
    static createInterface(): ControlListStorageWrapperInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): ControlListStorageWrapper;
}
