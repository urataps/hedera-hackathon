...
import type { KycStorageWrapper, KycStorageWrapperInterface } from "../../../../../contracts/layer_0/core/kyc/KycStorageWrapper";
export declare class KycStorageWrapper__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): KycStorageWrapper;
}
