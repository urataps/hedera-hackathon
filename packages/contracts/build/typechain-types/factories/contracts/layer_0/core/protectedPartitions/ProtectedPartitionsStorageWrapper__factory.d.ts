...
import type { ProtectedPartitionsStorageWrapper, ProtectedPartitionsStorageWrapperInterface } from "../../../../../contracts/layer_0/core/protectedPartitions/ProtectedPartitionsStorageWrapper";
export declare class ProtectedPartitionsStorageWrapper__factory {
    ...
    static createInterface(): ProtectedPartitionsStorageWrapperInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): ProtectedPartitionsStorageWrapper;
}
