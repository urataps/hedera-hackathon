...
import type { ExternalKycListManagementStorageWrapper, ExternalKycListManagementStorageWrapperInterface } from "../../../../../contracts/layer_0/core/externalKycLists/ExternalKycListManagementStorageWrapper";
export declare class ExternalKycListManagementStorageWrapper__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): ExternalKycListManagementStorageWrapper;
}
