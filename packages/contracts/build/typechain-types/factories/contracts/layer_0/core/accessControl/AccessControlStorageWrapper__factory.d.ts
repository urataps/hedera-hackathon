...
import type { AccessControlStorageWrapper, AccessControlStorageWrapperInterface } from "../../../../../contracts/layer_0/core/accessControl/AccessControlStorageWrapper";
export declare class AccessControlStorageWrapper__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): AccessControlStorageWrapper;
}
