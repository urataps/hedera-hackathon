...
import type { ExternalControlListManagementStorageWrapper, ExternalControlListManagementStorageWrapperInterface } from "../../../../../contracts/layer_0/core/externalControlLists/ExternalControlListManagementStorageWrapper";
export declare class ExternalControlListManagementStorageWrapper__factory {
    ...
    static createInterface(): ExternalControlListManagementStorageWrapperInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): ExternalControlListManagementStorageWrapper;
}
