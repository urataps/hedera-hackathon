...
import type { TransferAndLockStorageWrapper, TransferAndLockStorageWrapperInterface } from "../../../../contracts/layer_0/transferAndLock/TransferAndLockStorageWrapper";
export declare class TransferAndLockStorageWrapper__factory {
    ...
    static createInterface(): TransferAndLockStorageWrapperInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): TransferAndLockStorageWrapper;
}
