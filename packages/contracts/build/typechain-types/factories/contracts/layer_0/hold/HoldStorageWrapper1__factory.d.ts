...
import type { HoldStorageWrapper1, HoldStorageWrapper1Interface } from "../../../../contracts/layer_0/hold/HoldStorageWrapper1";
export declare class HoldStorageWrapper1__factory {
    ...
    static createInterface(): HoldStorageWrapper1Interface;
    static connect(address: string, signerOrProvider: Signer | Provider): HoldStorageWrapper1;
}
