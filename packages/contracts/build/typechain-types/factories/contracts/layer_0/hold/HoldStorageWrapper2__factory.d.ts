...
import type { HoldStorageWrapper2, HoldStorageWrapper2Interface } from "../../../../contracts/layer_0/hold/HoldStorageWrapper2";
export declare class HoldStorageWrapper2__factory {
    ...
    static createInterface(): HoldStorageWrapper2Interface;
    static connect(address: string, signerOrProvider: Signer | Provider): HoldStorageWrapper2;
}
