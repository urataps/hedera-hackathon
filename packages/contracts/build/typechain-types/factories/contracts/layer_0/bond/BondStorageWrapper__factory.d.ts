...
import type { BondStorageWrapper, BondStorageWrapperInterface } from "../../../../contracts/layer_0/bond/BondStorageWrapper";
export declare class BondStorageWrapper__factory {
    ...
    static createInterface(): BondStorageWrapperInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): BondStorageWrapper;
}
