...
import type { Security, SecurityInterface } from "../../../../contracts/layer_3/security/Security";
export declare class Security__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): Security;
}
