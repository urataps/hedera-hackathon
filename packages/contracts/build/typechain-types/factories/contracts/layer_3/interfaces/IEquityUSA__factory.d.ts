...
import type { IEquityUSA, IEquityUSAInterface } from "../../../../contracts/layer_3/interfaces/IEquityUSA";
export declare class IEquityUSA__factory {
    static readonly abi: readonly [{
        readonly inputs: readonly [{
            ...
            readonly name: "_equityDetailsData";
            readonly type: "tuple";
        }, {
            readonly components: readonly [{
        ...
        readonly name: "_initialize_equityUSA";
    ...
    static createInterface(): IEquityUSAInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): IEquityUSA;
}
