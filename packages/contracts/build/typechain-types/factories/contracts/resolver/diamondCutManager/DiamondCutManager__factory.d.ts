...
import type { DiamondCutManager, DiamondCutManagerInterface } from "../../../../contracts/resolver/diamondCutManager/DiamondCutManager";
export declare class DiamondCutManager__factory {
    ...
    static createInterface(): DiamondCutManagerInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): DiamondCutManager;
}
