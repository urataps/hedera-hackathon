...
import type { DiamondCutManagerWrapper, DiamondCutManagerWrapperInterface } from "../../../../contracts/resolver/diamondCutManager/DiamondCutManagerWrapper";
export declare class DiamondCutManagerWrapper__factory {
    ...
    static createInterface(): DiamondCutManagerWrapperInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): DiamondCutManagerWrapper;
}
