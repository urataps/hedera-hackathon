...
import type { ResolverProxyUnstructured, ResolverProxyUnstructuredInterface } from "../../../../../contracts/resolver/resolverProxy/unstructured/ResolverProxyUnstructured";
export declare class ResolverProxyUnstructured__factory {
    ...
    static createInterface(): ResolverProxyUnstructuredInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): ResolverProxyUnstructured;
}
