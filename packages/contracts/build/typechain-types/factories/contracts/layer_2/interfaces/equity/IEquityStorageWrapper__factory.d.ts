...
import type { IEquityStorageWrapper, IEquityStorageWrapperInterface } from "../../../../../contracts/layer_2/interfaces/equity/IEquityStorageWrapper";
export declare class IEquityStorageWrapper__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): IEquityStorageWrapper;
}
