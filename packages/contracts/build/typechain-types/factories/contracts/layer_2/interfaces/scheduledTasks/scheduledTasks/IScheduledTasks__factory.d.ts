...
import type { IScheduledTasks, IScheduledTasksInterface } from "../../../../../../contracts/layer_2/interfaces/scheduledTasks/scheduledTasks/IScheduledTasks";
export declare class IScheduledTasks__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): IScheduledTasks;
}
