...
import type { BondRead, BondReadInterface } from "../../../../contracts/layer_2/bond/BondRead";
export declare class BondRead__factory {
    ...
    static createInterface(): BondReadInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): BondRead;
}
