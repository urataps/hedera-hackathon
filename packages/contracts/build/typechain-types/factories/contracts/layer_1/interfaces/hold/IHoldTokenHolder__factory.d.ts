...
import type { IHoldTokenHolder, IHoldTokenHolderInterface } from "../../../../../contracts/layer_1/interfaces/hold/IHoldTokenHolder";
export declare class IHoldTokenHolder__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): IHoldTokenHolder;
}
