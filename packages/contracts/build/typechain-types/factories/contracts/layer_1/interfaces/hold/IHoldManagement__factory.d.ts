...
import type { IHoldManagement, IHoldManagementInterface } from "../../../../../contracts/layer_1/interfaces/hold/IHoldManagement";
export declare class IHoldManagement__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): IHoldManagement;
}
