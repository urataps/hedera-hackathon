...
import type { HoldManagement, HoldManagementInterface } from "../../../../contracts/layer_1/hold/HoldManagement";
export declare class HoldManagement__factory {
    ...
    static createInterface(): HoldManagementInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): HoldManagement;
}
