...
import type { HoldRead, HoldReadInterface } from "../../../../contracts/layer_1/hold/HoldRead";
export declare class HoldRead__factory {
    ...
    static createInterface(): HoldReadInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): HoldRead;
}
