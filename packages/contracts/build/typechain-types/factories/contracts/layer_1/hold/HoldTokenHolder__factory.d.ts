...
import type { HoldTokenHolder, HoldTokenHolderInterface } from "../../../../contracts/layer_1/hold/HoldTokenHolder";
export declare class HoldTokenHolder__factory {
    ...
    static createInterface(): HoldTokenHolderInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): HoldTokenHolder;
}
