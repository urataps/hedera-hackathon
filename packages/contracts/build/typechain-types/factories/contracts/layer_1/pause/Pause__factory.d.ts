...
import type { Pause, PauseInterface } from "../../../../contracts/layer_1/pause/Pause";
export declare class Pause__factory {
    ...
    static createInterface(): PauseInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): Pause;
}
