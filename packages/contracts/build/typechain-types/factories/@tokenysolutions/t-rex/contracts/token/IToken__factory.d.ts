...
import type { IToken, ITokenInterface } from "../../../../../@tokenysolutions/t-rex/contracts/token/IToken";
export declare class IToken__factory {
    static readonly abi: readonly [{
        ...
        readonly outputs: readonly [{
            readonly internalType: "contract IModularCompliance";
            readonly name: "";
            readonly type: "address";
        }];
        readonly stateMutability: "view";
