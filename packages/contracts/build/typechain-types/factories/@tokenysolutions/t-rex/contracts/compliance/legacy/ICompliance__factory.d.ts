...
import type { ICompliance, IComplianceInterface } from "../../../../../../@tokenysolutions/t-rex/contracts/compliance/legacy/ICompliance";
export declare class ICompliance__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): ICompliance;
}
