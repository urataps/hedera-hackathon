...
import type { IERC735, IERC735Interface } from "../../../../../@onchain-id/solidity/contracts/interface/IERC735";
export declare class IERC735__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): IERC735;
}
