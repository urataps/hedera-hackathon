...
import type { IClaimIssuer, IClaimIssuerInterface } from "../../../../../@onchain-id/solidity/contracts/interface/IClaimIssuer";
export declare class IClaimIssuer__factory {
    static readonly abi: readonly [{
        ...
        readonly name: "revokeClaimBySignature";
        readonly outputs: readonly [];
        readonly stateMutability: "nonpayable";
        readonly type: "function";
    }];
    static createInterface(): IClaimIssuerInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): IClaimIssuer;
}
