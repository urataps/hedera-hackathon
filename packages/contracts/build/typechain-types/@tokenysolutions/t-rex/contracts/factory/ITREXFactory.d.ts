...
export interface ITREXFactoryInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "deployTREXSuite" | "getIdFactory" | "getImplementationAuthority" | "getToken" | "recoverContractOwnership" | "setIdFactory" | "setImplementationAuthority"): FunctionFragment;
