...
export interface IIAFactoryInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "deployIA", values: [PromiseOrValue<string>]): string;
...
export interface IIAFactory extends BaseContract {
    ...
    functions: {
        deployIA(_token: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        deployedByFactory(_ia: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean]>;
    };
    deployIA(_token: PromiseOrValue<string>, overrides?: Overrides & {
        from?: PromiseOrValue<string>;
    }): Promise<ContractTransaction>;
    deployedByFactory(_ia: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
    callStatic: {
        deployIA(_token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>;
        deployedByFactory(_ia: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
    };
    filters: {
        "ImplementationAuthorityDeployed(address)"(_ia?: PromiseOrValue<string> | null): ImplementationAuthorityDeployedEventFilter;
        ImplementationAuthorityDeployed(_ia?: PromiseOrValue<string> | null): ImplementationAuthorityDeployedEventFilter;
    };
    estimateGas: {
        deployIA(_token: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        deployedByFactory(_ia: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        deployIA(_token: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
        deployedByFactory(_ia: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
