...
export interface IComplianceInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addTokenAgent" | "bindToken" | "canTransfer" | "created" | "destroyed" | "isTokenAgent" | "isTokenBound" | "removeTokenAgent" | "transferred" | "unbindToken"): FunctionFragment;
