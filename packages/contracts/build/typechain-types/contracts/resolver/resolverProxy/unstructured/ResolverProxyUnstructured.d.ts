...
export interface ResolverProxyUnstructuredInterface extends utils.Interface {
    functions: {};
    events: {
...
export interface ResolverProxyUnstructured extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ResolverProxyUnstructuredInterface;
