...
export interface ERC3643OperationsTimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "burn" | "forcedTransfer" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "mint"): FunctionFragment;
...
export interface ERC3643OperationsTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC3643OperationsTimeTravelInterface;
