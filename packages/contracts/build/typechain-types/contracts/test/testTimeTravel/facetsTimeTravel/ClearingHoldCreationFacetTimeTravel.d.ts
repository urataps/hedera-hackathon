...
export interface ClearingHoldCreationFacetTimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "clearingCreateHoldByPartition" | "clearingCreateHoldFromByPartition" | "getClearingCreateHoldForByPartition" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "operatorClearingCreateHoldByPartition" | "protectedClearingCreateHoldByPartition"): FunctionFragment;
...
export interface ClearingHoldCreationFacetTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ClearingHoldCreationFacetTimeTravelInterface;
