...
export interface ExternalPauseManagementTimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addExternalPause" | "getExternalPausesCount" | "getExternalPausesMembers" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "initialize_ExternalPauses" | "isExternalPause" | "removeExternalPause" | "updateExternalPauses"): FunctionFragment;
...
export interface ExternalPauseManagementTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ExternalPauseManagementTimeTravelInterface;
