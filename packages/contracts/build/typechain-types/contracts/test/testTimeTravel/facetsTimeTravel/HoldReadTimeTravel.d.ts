...
export interface HoldReadTimeTravelInterface extends utils.Interface {
    functions: {
...
export interface HoldReadTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HoldReadTimeTravelInterface;
