...
export interface ControlListTimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addToControlList" | "getControlListCount" | "getControlListMembers" | "getControlListType" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "initialize_ControlList" | "isInControlList" | "removeFromControlList"): FunctionFragment;
...
export interface ControlListTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ControlListTimeTravelInterface;
