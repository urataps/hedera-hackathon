...
export interface ERC3643ManagementTimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addAgent" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "initialize_ERC3643" | "recoveryAddress" | "removeAgent" | "setCompliance" | "setIdentityRegistry" | "setName" | "setOnchainID" | "setSymbol"): FunctionFragment;
...
export interface ERC3643ManagementTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC3643ManagementTimeTravelInterface;
