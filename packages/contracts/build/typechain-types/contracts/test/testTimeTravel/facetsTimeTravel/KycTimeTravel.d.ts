...
export interface KycTimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "activateInternalKyc" | "deactivateInternalKyc" | "getKycAccountsCount" | "getKycAccountsData" | "getKycFor" | "getKycStatusFor" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "grantKyc" | "initializeInternalKyc" | "isInternalKycActivated" | "revokeKyc"): FunctionFragment;
...
export interface KycTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: KycTimeTravelInterface;
    ...
    functions: {
        ...
        initializeInternalKyc(_internalKycActivated: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        initializeInternalKyc(_internalKycActivated: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
        isInternalKycActivated(overrides?: CallOverrides): Promise<boolean>;
