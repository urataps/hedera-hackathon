...
export interface AdjustBalancesTimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "adjustBalances" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey"): FunctionFragment;
    encodeFunctionData(functionFragment: "adjustBalances", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]): string;
    ...
    decodeFunctionResult(functionFragment: "adjustBalances", data: BytesLike): Result;
...
export interface AdjustBalancesTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AdjustBalancesTimeTravelInterface;
    ...
    functions: {
        adjustBalances(factor: PromiseOrValue<BigNumberish>, decimals: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
    ...
    getStaticResolverKey(overrides?: CallOverrides): Promise<string>;
    callStatic: {
        adjustBalances(factor: PromiseOrValue<BigNumberish>, decimals: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<boolean>;
        getStaticFunctionSelectors(overrides?: CallOverrides): Promise<string[]>;
        getStaticInterfaceIds(overrides?: CallOverrides): Promise<string[]>;
        getStaticResolverKey(overrides?: CallOverrides): Promise<string>;
    };
