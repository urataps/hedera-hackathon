...
export interface ERC1643TimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "getAllDocuments" | "getDocument" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "removeDocument" | "setDocument"): FunctionFragment;
...
export interface ERC1643TimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC1643TimeTravelInterface;
