...
export interface TransferAndLockTimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "protectedTransferAndLock" | "protectedTransferAndLockByPartition" | "transferAndLock" | "transferAndLockByPartition"): FunctionFragment;
...
export interface TransferAndLockTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TransferAndLockTimeTravelInterface;
