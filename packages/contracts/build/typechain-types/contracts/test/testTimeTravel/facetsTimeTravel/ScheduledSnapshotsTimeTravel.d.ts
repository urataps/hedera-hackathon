...
export interface ScheduledSnapshotsTimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "getScheduledSnapshots" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "onScheduledSnapshotTriggered" | "scheduledSnapshotCount"): FunctionFragment;
...
export interface ScheduledSnapshotsTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ScheduledSnapshotsTimeTravelInterface;
