...
export interface PauseFacetTimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "isPaused" | "pause" | "unpause"): FunctionFragment;
...
export interface PauseFacetTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: PauseFacetTimeTravelInterface;
