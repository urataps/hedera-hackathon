...
export interface ERC3643ReadTimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "compliance" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "identityRegistry" | "isAddressRecovered" | "isAgent" | "onchainID" | "version"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "isAddressRecovered", values: [PromiseOrValue<string>]): string;
    ...
    decodeFunctionResult(functionFragment: "isAddressRecovered", data: BytesLike): Result;
...
export interface ERC3643ReadTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC3643ReadTimeTravelInterface;
    ...
    functions: {
        ...
        isAddressRecovered(_wallet: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    estimateGas: {
        ...
        isAddressRecovered(_wallet: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        isAddressRecovered(_wallet: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
