...
export interface HoldManagementTimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "controllerCreateHoldByPartition" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "operatorCreateHoldByPartition" | "protectedCreateHoldByPartition"): FunctionFragment;
...
export interface HoldManagementTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HoldManagementTimeTravelInterface;
