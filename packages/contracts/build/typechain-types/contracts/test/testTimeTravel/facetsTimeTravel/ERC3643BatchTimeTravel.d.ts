...
export interface ERC3643BatchTimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "batchBurn" | "batchForcedTransfer" | "batchMint" | "batchTransfer" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey"): FunctionFragment;
...
export interface ERC3643BatchTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC3643BatchTimeTravelInterface;
