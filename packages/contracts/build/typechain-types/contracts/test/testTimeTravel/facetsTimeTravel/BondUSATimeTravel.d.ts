...
export interface BondUSATimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "_initialize_bondUSA" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "redeemAtMaturityByPartition" | "setCoupon" | "updateMaturityDate"): FunctionFragment;
...
export interface BondUSATimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: BondUSATimeTravelInterface;
    ...
    functions: {
        ...
        updateMaturityDate(_newMaturityDate: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    _initialize_bondUSA(_bondDetailsData: IBondRead.BondDetailsDataStruct, _couponDetailsData: IBondRead.CouponDetailsDataStruct, _regulationData: RegulationDataStruct, _additionalSecurityData: AdditionalSecurityDataStruct, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        updateMaturityDate(_newMaturityDate: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<boolean>;
    };
    filters: {
