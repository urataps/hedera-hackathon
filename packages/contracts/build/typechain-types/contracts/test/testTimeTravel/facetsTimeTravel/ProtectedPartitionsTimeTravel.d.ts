...
export interface ProtectedPartitionsTimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "arePartitionsProtected" | "calculateRoleForPartition" | "getNounceFor" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "initialize_ProtectedPartitions" | "protectPartitions" | "unprotectPartitions"): FunctionFragment;
    encodeFunctionData(functionFragment: "arePartitionsProtected", values?: undefined): string;
    encodeFunctionData(functionFragment: "calculateRoleForPartition", values: [PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: "getNounceFor", values: [PromiseOrValue<string>]): string;
    ...
    encodeFunctionData(functionFragment: "initialize_ProtectedPartitions", values: [PromiseOrValue<boolean>]): string;
    encodeFunctionData(functionFragment: "protectPartitions", values?: undefined): string;
    encodeFunctionData(functionFragment: "unprotectPartitions", values?: undefined): string;
    decodeFunctionResult(functionFragment: "arePartitionsProtected", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "calculateRoleForPartition", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getNounceFor", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "initialize_ProtectedPartitions", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "protectPartitions", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "unprotectPartitions", data: BytesLike): Result;
    events: {
...
export interface ProtectedPartitionsTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ProtectedPartitionsTimeTravelInterface;
    ...
    functions: {
        ...
        calculateRoleForPartition(partition: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[string] & {
            role: string;
        }>;
        getNounceFor(account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        initialize_ProtectedPartitions(_protectPartitions: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        protectPartitions(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        unprotectPartitions(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    arePartitionsProtected(overrides?: CallOverrides): Promise<boolean>;
    ...
    callStatic: {
        ...
        getStaticInterfaceIds(overrides?: CallOverrides): Promise<string[]>;
        getStaticResolverKey(overrides?: CallOverrides): Promise<string>;
        initialize_ProtectedPartitions(_protectPartitions: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<boolean>;
    ...
    estimateGas: {
        ...
        calculateRoleForPartition(partition: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        getNounceFor(account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        arePartitionsProtected(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        calculateRoleForPartition(partition: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getNounceFor(account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
