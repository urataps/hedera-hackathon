...
export interface ERC1644TimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "controllerRedeem" | "controllerTransfer" | "finalizeControllable" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "initialize_ERC1644" | "isControllable"): FunctionFragment;
...
export interface ERC1644TimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC1644TimeTravelInterface;
    ...
    functions: {
        ...
        initialize_ERC1644(_controllable: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getStaticInterfaceIds(overrides?: CallOverrides): Promise<string[]>;
        getStaticResolverKey(overrides?: CallOverrides): Promise<string>;
        initialize_ERC1644(_controllable: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
        isControllable(overrides?: CallOverrides): Promise<boolean>;
    };
    filters: {
