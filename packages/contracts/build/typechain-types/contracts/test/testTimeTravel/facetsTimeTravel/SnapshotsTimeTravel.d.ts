...
export interface SnapshotsTimeTravelInterface extends utils.Interface {
    functions: {
        ...
        "clearedBalanceOfAtSnapshot(uint256,address)": FunctionFragment;
        "clearedBalanceOfAtSnapshotByPartition(bytes32,uint256,address)": FunctionFragment;
        ...
        "heldBalanceOfAtSnapshot(uint256,address)": FunctionFragment;
        "heldBalanceOfAtSnapshotByPartition(bytes32,uint256,address)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "balanceOfAtSnapshot" | "balanceOfAtSnapshotByPartition" | "clearedBalanceOfAtSnapshot" | "clearedBalanceOfAtSnapshotByPartition" | "decimalsAtSnapshot" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "getTokenHoldersAtSnapshot" | "getTotalTokenHoldersAtSnapshot" | "heldBalanceOfAtSnapshot" | "heldBalanceOfAtSnapshotByPartition" | "lockedBalanceOfAtSnapshot" | "lockedBalanceOfAtSnapshotByPartition" | "partitionsOfAtSnapshot" | "takeSnapshot" | "totalSupplyAtSnapshot" | "totalSupplyAtSnapshotByPartition"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "clearedBalanceOfAtSnapshot", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "clearedBalanceOfAtSnapshotByPartition", values: [
        PromiseOrValue<BytesLike>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<string>
    ]): string;
    ...
    encodeFunctionData(functionFragment: "heldBalanceOfAtSnapshot", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "heldBalanceOfAtSnapshotByPartition", values: [
        PromiseOrValue<BytesLike>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<string>
    ]): string;
    ...
    decodeFunctionResult(functionFragment: "clearedBalanceOfAtSnapshot", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "clearedBalanceOfAtSnapshotByPartition", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "heldBalanceOfAtSnapshot", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "heldBalanceOfAtSnapshotByPartition", data: BytesLike): Result;
...
export interface SnapshotsTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SnapshotsTimeTravelInterface;
    ...
    functions: {
        ...
        clearedBalanceOfAtSnapshot(_snapshotID: PromiseOrValue<BigNumberish>, _tokenHolder: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber] & {
            balance_: BigNumber;
        }>;
        clearedBalanceOfAtSnapshotByPartition(_partition: PromiseOrValue<BytesLike>, _snapshotID: PromiseOrValue<BigNumberish>, _tokenHolder: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber] & {
            balance_: BigNumber;
        }>;
        ...
        heldBalanceOfAtSnapshot(_snapshotID: PromiseOrValue<BigNumberish>, _tokenHolder: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber] & {
            balance_: BigNumber;
        }>;
        heldBalanceOfAtSnapshotByPartition(_partition: PromiseOrValue<BytesLike>, _snapshotID: PromiseOrValue<BigNumberish>, _tokenHolder: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber] & {
            balance_: BigNumber;
        }>;
    ...
    populateTransaction: {
        ...
        clearedBalanceOfAtSnapshot(_snapshotID: PromiseOrValue<BigNumberish>, _tokenHolder: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        clearedBalanceOfAtSnapshotByPartition(_partition: PromiseOrValue<BytesLike>, _snapshotID: PromiseOrValue<BigNumberish>, _tokenHolder: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        heldBalanceOfAtSnapshot(_snapshotID: PromiseOrValue<BigNumberish>, _tokenHolder: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        heldBalanceOfAtSnapshotByPartition(_partition: PromiseOrValue<BytesLike>, _snapshotID: PromiseOrValue<BigNumberish>, _tokenHolder: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
