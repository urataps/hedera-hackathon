...
export interface FreezeFacetTimeTravelInterface extends utils.Interface {
    functions: {
...
export interface FreezeFacetTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: FreezeFacetTimeTravelInterface;
