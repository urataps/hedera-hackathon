...
export declare namespace IBondRead {
    ...
    type RegisteredCouponStruct = {
        coupon: IBondRead.CouponStruct;
        snapshotId: PromiseOrValue<BigNumberish>;
    };
    type RegisteredCouponStructOutput = [
        IBondRead.CouponStructOutput,
        BigNumber
    ] & {
        coupon: IBondRead.CouponStructOutput;
...
export interface BondUSAReadTimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "getBondDetails" | "getCoupon" | "getCouponCount" | "getCouponDetails" | "getCouponFor" | "getCouponHolders" | "getSecurityHolders" | "getSecurityRegulationData" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "getTotalCouponHolders" | "getTotalSecurityHolders"): FunctionFragment;
...
export interface BondUSAReadTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: BondUSAReadTimeTravelInterface;
    ...
    functions: {
        getBondDetails(overrides?: CallOverrides): Promise<[
            ...
            bondDetailsData_: IBondRead.BondDetailsDataStructOutput;
        }>;
        getCoupon(_couponID: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[
            IBondRead.RegisteredCouponStructOutput
        ] & {
            registeredCoupon_: IBondRead.RegisteredCouponStructOutput;
        }>;
        ...
        getCouponDetails(overrides?: CallOverrides): Promise<[
            ...
            couponDetails_: IBondRead.CouponDetailsDataStructOutput;
        }>;
        getCouponFor(_couponID: PromiseOrValue<BigNumberish>, _account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[
            IBondRead.CouponForStructOutput
        ] & {
            couponFor_: IBondRead.CouponForStructOutput;
        }>;
    ...
    getBondDetails(overrides?: CallOverrides): Promise<IBondRead.BondDetailsDataStructOutput>;
    getCoupon(_couponID: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<IBondRead.RegisteredCouponStructOutput>;
    getCouponCount(overrides?: CallOverrides): Promise<BigNumber>;
    getCouponDetails(overrides?: CallOverrides): Promise<IBondRead.CouponDetailsDataStructOutput>;
    getCouponFor(_couponID: PromiseOrValue<BigNumberish>, _account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<IBondRead.CouponForStructOutput>;
    getCouponHolders(_couponID: PromiseOrValue<BigNumberish>, _pageIndex: PromiseOrValue<BigNumberish>, _pageLength: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string[]>;
    getSecurityHolders(_pageIndex: PromiseOrValue<BigNumberish>, _pageLength: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string[]>;
