...
export interface HoldTokenHolderTimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "createHoldByPartition" | "createHoldFromByPartition" | "executeHoldByPartition" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "reclaimHoldByPartition" | "releaseHoldByPartition"): FunctionFragment;
...
export interface HoldTokenHolderTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HoldTokenHolderTimeTravelInterface;
