...
export interface CorporateActionsTimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addCorporateAction" | "getCorporateAction" | "getCorporateActionCount" | "getCorporateActionCountByType" | "getCorporateActionIds" | "getCorporateActionIdsByType" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey"): FunctionFragment;
...
export interface CorporateActionsTimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CorporateActionsTimeTravelInterface;
