...
export interface ComplianceMockInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "setFlagsByMethod", values: [
...
export interface ComplianceMock extends BaseContract {
    ...
    functions: {
        ...
        setFlags(_canTransferFlag: PromiseOrValue<boolean>, _revertFlag: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        setFlagsByMethod(_canTransferFlag: PromiseOrValue<boolean>[], _canTransferKey: PromiseOrValue<BytesLike>[], _revertFlag: PromiseOrValue<boolean>[], _revertKey: PromiseOrValue<BytesLike>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        destroyedHit(overrides?: CallOverrides): Promise<BigNumber>;
        setFlags(_canTransferFlag: PromiseOrValue<boolean>, _revertFlag: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
        setFlagsByMethod(_canTransferFlag: PromiseOrValue<boolean>[], _canTransferKey: PromiseOrValue<BytesLike>[], _revertFlag: PromiseOrValue<boolean>[], _revertKey: PromiseOrValue<BytesLike>[], overrides?: CallOverrides): Promise<void>;
