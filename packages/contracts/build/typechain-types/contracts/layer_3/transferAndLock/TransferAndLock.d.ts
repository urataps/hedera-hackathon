...
export interface TransferAndLockInterface extends utils.Interface {
    functions: {
...
export interface TransferAndLock extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TransferAndLockInterface;
