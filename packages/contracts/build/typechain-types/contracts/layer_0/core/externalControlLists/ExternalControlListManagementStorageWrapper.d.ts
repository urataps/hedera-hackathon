...
export interface ExternalControlListManagementStorageWrapperInterface extends utils.Interface {
    functions: {};
    events: {
...
export interface ExternalControlListManagementStorageWrapper extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ExternalControlListManagementStorageWrapperInterface;
