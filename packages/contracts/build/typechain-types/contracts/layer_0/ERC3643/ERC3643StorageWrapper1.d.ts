...
export interface ERC3643StorageWrapper1Interface extends utils.Interface {
    functions: {};
    events: {
...
export interface ERC3643StorageWrapper1 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC3643StorageWrapper1Interface;
