...
export interface CorporateActionsStorageWrapper2Interface extends utils.Interface {
    functions: {};
    events: {
...
export interface CorporateActionsStorageWrapper2 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CorporateActionsStorageWrapper2Interface;
