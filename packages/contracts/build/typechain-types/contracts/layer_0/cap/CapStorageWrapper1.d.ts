...
export interface CapStorageWrapper1Interface extends utils.Interface {
    functions: {};
    events: {
...
export interface CapStorageWrapper1 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CapStorageWrapper1Interface;
