...
export interface CapStorageWrapper2Interface extends utils.Interface {
    functions: {};
    events: {
...
export interface CapStorageWrapper2 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CapStorageWrapper2Interface;
