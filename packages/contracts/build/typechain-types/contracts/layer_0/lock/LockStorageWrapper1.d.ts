...
export interface LockStorageWrapper1Interface extends utils.Interface {
    functions: {};
    events: {
...
export interface LockStorageWrapper1 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LockStorageWrapper1Interface;
