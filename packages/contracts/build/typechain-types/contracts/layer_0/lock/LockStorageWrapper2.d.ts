...
export interface LockStorageWrapper2Interface extends utils.Interface {
    functions: {};
    events: {
...
export interface LockStorageWrapper2 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LockStorageWrapper2Interface;
