...
export interface ClearingStorageWrapper1Interface extends utils.Interface {
    functions: {};
    events: {
...
export interface ClearingStorageWrapper1 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ClearingStorageWrapper1Interface;
