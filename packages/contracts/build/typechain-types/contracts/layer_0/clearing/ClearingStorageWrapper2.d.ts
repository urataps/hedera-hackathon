...
export interface ClearingStorageWrapper2Interface extends utils.Interface {
    functions: {};
    events: {
...
export interface ClearingStorageWrapper2 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ClearingStorageWrapper2Interface;
