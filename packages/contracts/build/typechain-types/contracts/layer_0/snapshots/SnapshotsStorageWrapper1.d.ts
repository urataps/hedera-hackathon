...
export interface SnapshotsStorageWrapper1Interface extends utils.Interface {
    functions: {};
    events: {
...
export interface SnapshotsStorageWrapper1 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SnapshotsStorageWrapper1Interface;
