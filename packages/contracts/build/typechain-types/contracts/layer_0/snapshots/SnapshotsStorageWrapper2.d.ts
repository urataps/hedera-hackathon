...
export interface SnapshotsStorageWrapper2Interface extends utils.Interface {
    functions: {};
    events: {
...
export interface SnapshotsStorageWrapper2 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SnapshotsStorageWrapper2Interface;
