...
export interface ScheduledBalanceAdjustmentsStorageWrapperInterface extends utils.Interface {
    functions: {};
    events: {
...
export interface ScheduledBalanceAdjustmentsStorageWrapper extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ScheduledBalanceAdjustmentsStorageWrapperInterface;
