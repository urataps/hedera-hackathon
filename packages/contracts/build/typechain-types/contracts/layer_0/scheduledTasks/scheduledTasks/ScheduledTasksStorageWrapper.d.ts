...
export interface ScheduledTasksStorageWrapperInterface extends utils.Interface {
    functions: {};
    events: {
...
export interface ScheduledTasksStorageWrapper extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ScheduledTasksStorageWrapperInterface;
