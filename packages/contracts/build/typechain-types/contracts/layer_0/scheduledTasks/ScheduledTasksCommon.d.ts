...
export interface ScheduledTasksCommonInterface extends utils.Interface {
    functions: {};
    events: {
...
export interface ScheduledTasksCommon extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ScheduledTasksCommonInterface;
