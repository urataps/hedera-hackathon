...
export interface TransferAndLockStorageWrapperInterface extends utils.Interface {
    functions: {};
    events: {
...
export interface TransferAndLockStorageWrapper extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TransferAndLockStorageWrapperInterface;
