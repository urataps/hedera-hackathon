...
export interface AdjustBalancesStorageWrapper2Interface extends utils.Interface {
    functions: {};
    events: {
...
export interface AdjustBalancesStorageWrapper2 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AdjustBalancesStorageWrapper2Interface;
