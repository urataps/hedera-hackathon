...
export interface ERC20StorageWrapper2Interface extends utils.Interface {
    functions: {};
    events: {
...
export interface ERC20StorageWrapper2 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC20StorageWrapper2Interface;
