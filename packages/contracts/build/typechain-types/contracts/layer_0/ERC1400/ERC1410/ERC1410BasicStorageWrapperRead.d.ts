...
export interface ERC1410BasicStorageWrapperReadInterface extends utils.Interface {
    functions: {};
    events: {
...
export interface ERC1410BasicStorageWrapperRead extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC1410BasicStorageWrapperReadInterface;
