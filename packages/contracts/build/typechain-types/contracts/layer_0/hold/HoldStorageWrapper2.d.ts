...
export interface HoldStorageWrapper2Interface extends utils.Interface {
    functions: {};
    events: {
...
export interface HoldStorageWrapper2 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HoldStorageWrapper2Interface;
