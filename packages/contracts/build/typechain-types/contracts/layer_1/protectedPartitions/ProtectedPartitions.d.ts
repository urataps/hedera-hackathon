...
export interface ProtectedPartitionsInterface extends utils.Interface {
    functions: {
...
export interface ProtectedPartitions extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ProtectedPartitionsInterface;
