...
export interface ExternalControlListManagementInterface extends utils.Interface {
    functions: {
...
export interface ExternalControlListManagement extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ExternalControlListManagementInterface;
