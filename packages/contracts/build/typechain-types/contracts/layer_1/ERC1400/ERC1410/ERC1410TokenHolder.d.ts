...
export interface ERC1410TokenHolderInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "authorizeOperator" | "authorizeOperatorByPartition" | "redeemByPartition" | "revokeOperator" | "revokeOperatorByPartition" | "transferByPartition" | "triggerAndSyncAll"): FunctionFragment;
...
export interface ERC1410TokenHolder extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC1410TokenHolderInterface;
