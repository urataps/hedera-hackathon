...
export interface ERC1410ReadFacetInterface extends utils.Interface {
    functions: {
...
export interface ERC1410ReadFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC1410ReadFacetInterface;
