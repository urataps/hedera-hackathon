...
export interface ERC1410TokenHolderFacetInterface extends utils.Interface {
    functions: {
...
export interface ERC1410TokenHolderFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC1410TokenHolderFacetInterface;
