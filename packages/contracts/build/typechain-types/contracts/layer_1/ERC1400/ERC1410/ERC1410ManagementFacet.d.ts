...
export interface ERC1410ManagementFacetInterface extends utils.Interface {
    functions: {
...
export interface ERC1410ManagementFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC1410ManagementFacetInterface;
