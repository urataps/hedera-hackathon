...
export interface FreezeInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "batchFreezePartialTokens" | "batchSetAddressFrozen" | "batchUnfreezePartialTokens" | "freezePartialTokens" | "getFrozenTokens" | "setAddressFrozen" | "unfreezePartialTokens"): FunctionFragment;
...
export interface Freeze extends BaseContract {
    ...
    functions: {
        ...
        setAddressFrozen(_userAddress: PromiseOrValue<string>, _freezStatus: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getFrozenTokens(_userAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        setAddressFrozen(_userAddress: PromiseOrValue<string>, _freezStatus: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
