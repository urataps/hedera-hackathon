...
export interface ClearingActionsFacetInterface extends utils.Interface {
    functions: {
...
export interface ClearingActionsFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ClearingActionsFacetInterface;
