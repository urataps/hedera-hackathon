...
export interface ClearingTransferFacetInterface extends utils.Interface {
    functions: {
...
export interface ClearingTransferFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ClearingTransferFacetInterface;
