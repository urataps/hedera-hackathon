...
export interface ClearingRedeemFacetInterface extends utils.Interface {
    functions: {
...
export interface ClearingRedeemFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ClearingRedeemFacetInterface;
