...
export interface ExternalPauseManagementInterface extends utils.Interface {
    functions: {
...
export interface ExternalPauseManagement extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ExternalPauseManagementInterface;
