...
export interface HoldTokenHolderInterface extends utils.Interface {
    functions: {
...
export interface HoldTokenHolder extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HoldTokenHolderInterface;
