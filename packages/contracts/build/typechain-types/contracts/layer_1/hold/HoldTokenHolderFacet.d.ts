...
export interface HoldTokenHolderFacetInterface extends utils.Interface {
    functions: {
...
export interface HoldTokenHolderFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HoldTokenHolderFacetInterface;
