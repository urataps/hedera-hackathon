...
export interface HoldManagementFacetInterface extends utils.Interface {
    functions: {
...
export interface HoldManagementFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HoldManagementFacetInterface;
