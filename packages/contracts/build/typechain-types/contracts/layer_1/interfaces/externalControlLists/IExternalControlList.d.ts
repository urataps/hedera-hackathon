...
export interface IExternalControlListInterface extends utils.Interface {
    functions: {
...
export interface IExternalControlList extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IExternalControlListInterface;
