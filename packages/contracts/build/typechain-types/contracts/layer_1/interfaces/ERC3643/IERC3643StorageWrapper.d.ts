...
export interface IERC3643StorageWrapperInterface extends utils.Interface {
    functions: {};
    events: {
...
export interface IERC3643StorageWrapper extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IERC3643StorageWrapperInterface;
