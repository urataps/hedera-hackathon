...
export interface ERC3643ManagementFacetInterface extends utils.Interface {
    functions: {
...
export interface ERC3643ManagementFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC3643ManagementFacetInterface;
