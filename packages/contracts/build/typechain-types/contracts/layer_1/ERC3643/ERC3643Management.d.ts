...
export interface ERC3643ManagementInterface extends utils.Interface {
    functions: {
...
export interface ERC3643Management extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC3643ManagementInterface;
