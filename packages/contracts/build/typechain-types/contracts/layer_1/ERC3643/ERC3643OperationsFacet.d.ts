...
export interface ERC3643OperationsFacetInterface extends utils.Interface {
    functions: {
...
export interface ERC3643OperationsFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC3643OperationsFacetInterface;
