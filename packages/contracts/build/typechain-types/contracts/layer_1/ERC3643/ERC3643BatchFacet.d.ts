...
export interface ERC3643BatchFacetInterface extends utils.Interface {
    functions: {
...
export interface ERC3643BatchFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC3643BatchFacetInterface;
