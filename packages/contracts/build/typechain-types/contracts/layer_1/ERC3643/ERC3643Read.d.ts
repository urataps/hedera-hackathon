...
export interface ERC3643ReadInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "compliance" | "identityRegistry" | "isAddressRecovered" | "isAgent" | "onchainID" | "version"): FunctionFragment;
...
export interface ERC3643Read extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC3643ReadInterface;
