...
export interface ERC3643ReadFacetInterface extends utils.Interface {
    functions: {
...
export interface ERC3643ReadFacet extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC3643ReadFacetInterface;
