...
export interface ERC3643OperationsInterface extends utils.Interface {
    functions: {
...
export interface ERC3643Operations extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC3643OperationsInterface;
