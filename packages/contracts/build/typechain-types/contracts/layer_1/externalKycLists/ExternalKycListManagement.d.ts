...
export interface ExternalKycListManagementInterface extends utils.Interface {
    functions: {
...
export interface ExternalKycListManagement extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ExternalKycListManagementInterface;
