...
export declare namespace TRexIEquity {
    ...
    type RegisteredDividendStructOutput = [
        ...
        dividend: TRexIEquity.DividendStructOutput;
    ...
    type RegisteredVotingStructOutput = [
        ...
        voting: TRexIEquity.VotingStructOutput;
        snapshotId: BigNumber;
    };
...
export interface TRexIEquityInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "setDividends", values: [TRexIEquity.DividendStruct]): string;
    encodeFunctionData(functionFragment: "setScheduledBalanceAdjustment", values: [TRexIEquity.ScheduledBalanceAdjustmentStruct]): string;
    encodeFunctionData(functionFragment: "setVoting", values: [TRexIEquity.VotingStruct]): string;
...
export interface TRexIEquity extends BaseContract {
    ...
    functions: {
        ...
        setDividends(_newDividend: TRexIEquity.DividendStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        setScheduledBalanceAdjustment(_newBalanceAdjustment: TRexIEquity.ScheduledBalanceAdjustmentStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        setVoting(_newVoting: TRexIEquity.VotingStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    getDividendHolders(_dividendID: PromiseOrValue<BigNumberish>, _pageIndex: PromiseOrValue<BigNumberish>, _pageLength: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string[]>;
    getDividends(_dividendID: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<TRexIEquity.RegisteredDividendStructOutput>;
    getDividendsCount(overrides?: CallOverrides): Promise<BigNumber>;
    getDividendsFor(_dividendID: PromiseOrValue<BigNumberish>, _account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<TRexIEquity.DividendForStructOutput>;
    getEquityDetails(overrides?: CallOverrides): Promise<TRexIEquity.EquityDetailsDataStructOutput>;
    getScheduledBalanceAdjustment(_balanceAdjustmentID: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<TRexIEquity.ScheduledBalanceAdjustmentStructOutput>;
    getScheduledBalanceAdjustmentCount(overrides?: CallOverrides): Promise<BigNumber>;
    getTotalDividendHolders(_dividendID: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    getTotalVotingHolders(_voteID: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    getVoting(_voteID: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<TRexIEquity.RegisteredVotingStructOutput>;
    getVotingCount(overrides?: CallOverrides): Promise<BigNumber>;
    getVotingFor(_voteID: PromiseOrValue<BigNumberish>, _account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<TRexIEquity.VotingForStructOutput>;
    getVotingHolders(_voteID: PromiseOrValue<BigNumberish>, _pageIndex: PromiseOrValue<BigNumberish>, _pageLength: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string[]>;
    setDividends(_newDividend: TRexIEquity.DividendStruct, overrides?: Overrides & {
        from?: PromiseOrValue<string>;
    }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        getVotingFor(_voteID: PromiseOrValue<BigNumberish>, _account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<TRexIEquity.VotingForStructOutput>;
        getVotingHolders(_voteID: PromiseOrValue<BigNumberish>, _pageIndex: PromiseOrValue<BigNumberish>, _pageLength: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string[]>;
        setDividends(_newDividend: TRexIEquity.DividendStruct, overrides?: CallOverrides): Promise<[
            boolean,
            BigNumber
        ] & {
            success_: boolean;
        ...
        setScheduledBalanceAdjustment(_newBalanceAdjustment: TRexIEquity.ScheduledBalanceAdjustmentStruct, overrides?: CallOverrides): Promise<[
            boolean,
            BigNumber
        ] & {
            success_: boolean;
        ...
        setVoting(_newVoting: TRexIEquity.VotingStruct, overrides?: CallOverrides): Promise<[
            boolean,
            BigNumber
        ] & {
            success_: boolean;
