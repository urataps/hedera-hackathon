...
export interface TRexIBusinessLogicResolverInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addSelectorsToBlacklist" | "getBusinessLogicCount" | "getBusinessLogicKeys" | "getLatestVersion" | "getSelectorsBlacklist" | "getVersionStatus" | "initialize_BusinessLogicResolver" | "registerBusinessLogics" | "removeSelectorsFromBlacklist" | "resolveBusinessLogicByVersion" | "resolveLatestBusinessLogic"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "registerBusinessLogics", values: [TRexIBusinessLogicResolver.BusinessLogicRegistryDataStruct[]]): string;
...
export interface TRexIBusinessLogicResolver extends BaseContract {
    ...
    functions: {
        ...
        registerBusinessLogics(_businessLogics: TRexIBusinessLogicResolver.BusinessLogicRegistryDataStruct[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        registerBusinessLogics(_businessLogics: TRexIBusinessLogicResolver.BusinessLogicRegistryDataStruct[], overrides?: CallOverrides): Promise<void>;
