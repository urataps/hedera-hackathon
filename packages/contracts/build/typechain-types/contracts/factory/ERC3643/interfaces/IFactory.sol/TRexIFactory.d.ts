...
export interface TRexIFactoryInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "deployBond", values: [TRexIFactory.BondDataStruct, FactoryRegulationDataStruct]): string;
    encodeFunctionData(functionFragment: "deployEquity", values: [TRexIFactory.EquityDataStruct, FactoryRegulationDataStruct]): string;
...
export interface TRexIFactory extends BaseContract {
    ...
    functions: {
        deployBond(_bondData: TRexIFactory.BondDataStruct, _factoryRegulationData: FactoryRegulationDataStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        deployEquity(_equityData: TRexIFactory.EquityDataStruct, _factoryRegulationData: FactoryRegulationDataStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        deployBond(_bondData: TRexIFactory.BondDataStruct, _factoryRegulationData: FactoryRegulationDataStruct, overrides?: CallOverrides): Promise<string>;
        deployEquity(_equityData: TRexIFactory.EquityDataStruct, _factoryRegulationData: FactoryRegulationDataStruct, overrides?: CallOverrides): Promise<string>;
        getAppliedRegulationData(_regulationType: PromiseOrValue<BigNumberish>, _regulationSubType: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<RegulationDataStructOutput>;
    };
    filters: {
