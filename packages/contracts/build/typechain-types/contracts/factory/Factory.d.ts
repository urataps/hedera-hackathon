...
export declare namespace IFactory {
    ...
    type SecurityDataStruct = {
        ...
        resolverProxyConfiguration: IFactory.ResolverProxyConfigurationStruct;
        rbacs: IResolverProxy.RbacStruct[];
        isControllable: PromiseOrValue<boolean>;
        isWhiteList: PromiseOrValue<boolean>;
        maxSupply: PromiseOrValue<BigNumberish>;
        erc20MetadataInfo: IERC20.ERC20MetadataInfoStruct;
    ...
    type SecurityDataStructOutput = [
        ...
        boolean,
        string,
        IFactory.ResolverProxyConfigurationStructOutput,
        IResolverProxy.RbacStructOutput[],
        boolean,
        boolean,
        BigNumber,
        ...
        resolver: string;
        resolverProxyConfiguration: IFactory.ResolverProxyConfigurationStructOutput;
        rbacs: IResolverProxy.RbacStructOutput[];
        isControllable: boolean;
        isWhiteList: boolean;
        maxSupply: BigNumber;
        erc20MetadataInfo: IERC20.ERC20MetadataInfoStructOutput;
    ...
    type BondDataStruct = {
        security: IFactory.SecurityDataStruct;
        bondDetails: IBondRead.BondDetailsDataStruct;
        couponDetails: IBondRead.CouponDetailsDataStruct;
    };
    type BondDataStructOutput = [
        IFactory.SecurityDataStructOutput,
        IBondRead.BondDetailsDataStructOutput,
        IBondRead.CouponDetailsDataStructOutput
    ] & {
        security: IFactory.SecurityDataStructOutput;
        bondDetails: IBondRead.BondDetailsDataStructOutput;
        couponDetails: IBondRead.CouponDetailsDataStructOutput;
    };
    type EquityDataStruct = {
        security: IFactory.SecurityDataStruct;
        equityDetails: IEquity.EquityDetailsDataStruct;
    };
    type EquityDataStructOutput = [
        ...
        security: IFactory.SecurityDataStructOutput;
        equityDetails: IEquity.EquityDetailsDataStructOutput;
    };
}
export declare namespace IResolverProxy {
    type RbacStruct = {
...
export interface FactoryInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "deployBond", values: [IFactory.BondDataStruct, FactoryRegulationDataStruct]): string;
    encodeFunctionData(functionFragment: "deployEquity", values: [IFactory.EquityDataStruct, FactoryRegulationDataStruct]): string;
    encodeFunctionData(functionFragment: "getAppliedRegulationData", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]): string;
...
export interface EquityDeployedEventObject {
    ...
    equityData: IFactory.EquityDataStructOutput;
    regulationData: FactoryRegulationDataStructOutput;
}
export type EquityDeployedEvent = TypedEvent<[
    string,
    string,
    IFactory.EquityDataStructOutput,
    FactoryRegulationDataStructOutput
...
export interface Factory extends BaseContract {
    ...
    functions: {
        deployBond(_bondData: IFactory.BondDataStruct, _factoryRegulationData: FactoryRegulationDataStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        deployEquity(_equityData: IFactory.EquityDataStruct, _factoryRegulationData: FactoryRegulationDataStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        getAppliedRegulationData(_regulationType: PromiseOrValue<BigNumberish>, _regulationSubType: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[
    ...
    getAppliedRegulationData(_regulationType: PromiseOrValue<BigNumberish>, _regulationSubType: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<RegulationDataStructOutput>;
    callStatic: {
        deployBond(_bondData: IFactory.BondDataStruct, _factoryRegulationData: FactoryRegulationDataStruct, overrides?: CallOverrides): Promise<string>;
        deployEquity(_equityData: IFactory.EquityDataStruct, _factoryRegulationData: FactoryRegulationDataStruct, overrides?: CallOverrides): Promise<string>;
        getAppliedRegulationData(_regulationType: PromiseOrValue<BigNumberish>, _regulationSubType: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<RegulationDataStructOutput>;
    };
    filters: {
        "BondDeployed(address,address,tuple,tuple)"(deployer?: PromiseOrValue<string> | null, bondAddress?: null, bondData?: null, regulationData?: null): BondDeployedEventFilter;
        BondDeployed(deployer?: PromiseOrValue<string> | null, bondAddress?: null, bondData?: null, regulationData?: null): BondDeployedEventFilter;
        "EquityDeployed(address,address,tuple,tuple)"(deployer?: PromiseOrValue<string> | null, equityAddress?: null, equityData?: null, regulationData?: null): EquityDeployedEventFilter;
        EquityDeployed(deployer?: PromiseOrValue<string> | null, equityAddress?: null, equityData?: null, regulationData?: null): EquityDeployedEventFilter;
    };
    estimateGas: {
        deployBond(_bondData: IFactory.BondDataStruct, _factoryRegulationData: FactoryRegulationDataStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        ...
        getAppliedRegulationData(_regulationType: PromiseOrValue<BigNumberish>, _regulationSubType: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        deployBond(_bondData: IFactory.BondDataStruct, _factoryRegulationData: FactoryRegulationDataStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        ...
        getAppliedRegulationData(_regulationType: PromiseOrValue<BigNumberish>, _regulationSubType: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
