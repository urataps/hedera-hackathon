...
export interface ScheduledBalanceAdjustmentsInterface extends utils.Interface {
    functions: {
...
export interface ScheduledBalanceAdjustments extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ScheduledBalanceAdjustmentsInterface;
