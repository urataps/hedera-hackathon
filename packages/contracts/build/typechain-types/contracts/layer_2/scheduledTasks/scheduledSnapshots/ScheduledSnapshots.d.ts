...
export interface ScheduledSnapshotsInterface extends utils.Interface {
    functions: {
...
export interface ScheduledSnapshots extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ScheduledSnapshotsInterface;
