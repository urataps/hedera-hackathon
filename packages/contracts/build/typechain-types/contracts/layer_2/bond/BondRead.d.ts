...
export interface BondReadInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "getBondDetails" | "getCoupon" | "getCouponCount" | "getCouponDetails" | "getCouponFor" | "getCouponHolders" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "getTotalCouponHolders"): FunctionFragment;
...
export interface BondRead extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: BondReadInterface;
