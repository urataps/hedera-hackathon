...
exports.CONTRACT_FACTORY_NAMES = exports.CONTRACT_NAMES_WITH_PROXY = exports.LIBRARY_NAMES = exports.CONTRACT_NAMES = exports.DEPLOY_TYPES = exports.NETWORKS = void 0;
...
exports.DEPLOY_TYPES = ['proxy', 'direct'];
...
exports.LIBRARY_NAMES = [
    'SecurityDeploymentLib',
    'TREXBaseDeploymentLib',
    'TREXBondDeploymentLib',
    'TREXEquityDeploymentLib',
];
exports.CONTRACT_NAMES_WITH_PROXY = ['Factory', 'BusinessLogicResolver'];
exports.CONTRACT_FACTORY_NAMES = exports.CONTRACT_NAMES.map((name) => `${name}__factory`);
class Configuration {
     ...
     */
    static get contractSizerRunOnCompile() {
        return (Configuration._getEnvironmentVariable({
    ...
    static get privateKeys() {
        return exports.NETWORKS.reduce((result, network) => {
    ...
    static get contracts() {
        const contracts = {};
        exports.CONTRACT_NAMES.forEach((contractName) => {
            contracts[contractName] = {
                name: contractName,
                factoryName: `${contractName}__factory`,
                deployType: exports.CONTRACT_NAMES_WITH_PROXY.includes(contractName)
                    ? 'proxy'
                    : 'direct',
     ...
     */
    static _getDeployedAddresses({ contractName, }) {
    ...
    static _getEnvironmentVariableList({ name, indexChar = '#', }) {
        const resultList = [];
        let index = 0;
        do {
    ...
    static _getEnvironmentVariable({ name, defaultValue, }) {
