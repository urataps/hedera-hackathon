...
class RegisterDeployedContractBusinessLogicsCommand extends _scripts_1.BaseAtsContractListCommand {
    constructor({ deployedContractList, signer, overrides, }) {
        ...
        if (!businessLogicResolver.proxyAddress) {
            throw new _scripts_1.BusinessLogicResolverProxyNotFound();
        }
        super({
            contractAddressList,
...
exports.default = RegisterDeployedContractBusinessLogicsCommand;
