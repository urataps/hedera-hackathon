...
class CreateConfigurationsForDeployedContractsCommand extends index_1.BaseAtsContractListCommand {
    equityUsaAddress;
    bondUsaAddress;
    excludeEquityAddresses = [];
    excludeBondAddresses = [];
    constructor({ deployedContractList, signer, overrides, }) {
        const { 
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        deployer: _, businessLogicResolver, equityUsa, bondUsa, ...contractListToRegister } = deployedContractList;
        if (!businessLogicResolver.proxyAddress) {
            throw new index_1.BusinessLogicResolverProxyNotFound();
        }
    ...
    get commonFacetAddressList() {
        ...
        return this.equityFacetAddressList.filter((address) => bondFacetSet.has(address));
    }
    get equityFacetAddressList() {
        return [
            ...this.getFilteredFacetAddresses(this.excludeEquityAddresses),
            this.equityUsaAddress,
        ];
    }
    get bondFacetAddressList() {
        return [
            ...this.getFilteredFacetAddresses(this.excludeBondAddresses),
            this.bondUsaAddress,
        ];
    }
    getFilteredFacetAddresses(excludeList) {
        return this.contractAddressList.filter((address) => !excludeList.includes(address));
    }
}
exports.default = CreateConfigurationsForDeployedContractsCommand;
