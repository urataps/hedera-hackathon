...
const DeployAtsFullInfrastructureResult_1 = tslib_1.__importDefault(require("./results/DeployAtsFullInfrastructureResult"));
class Environment {
    commonFacetIdList;
    equityFacetIdList;
    bondFacetIdList;
    ...
    factory;
    deployedContracts;
    constructor({ commonFacetIdList, equityFacetIdList, bondFacetIdList, equityFacetVersionList, bondFacetVersionList, businessLogicResolver, factory, deployedContracts, }) {
    ...
    toDeployAtsFullInfrastructureResult() {
        const { commonFacetIdList, equityFacetIdList, bondFacetIdList, equityFacetVersionList, bondFacetVersionList, factory, deployedContracts, } = this._validateInitialization();
        return new DeployAtsFullInfrastructureResult_1.default({
            facetLists: {
                commonFacetIdList,
                equityFacetIdList,
                bondFacetIdList,
            ...
            factory: new _scripts_1.DeployContractWithFactoryResult({
