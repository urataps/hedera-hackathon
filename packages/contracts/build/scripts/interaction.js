...
exports.callReadContract = callReadContract;
exports.callWriteContract = callWriteContract;
 ...
 */
async function callReadContract({ contract, method, args, overrides, }) {
 ...
 */
async function callWriteContract({ contract, method, args, overrides, }) {
    const command = new _scripts_1.CallContractCommand({
        contract,
        method,
        args,
        overrides,
    });
    const response = (await callContract(command));
 ...
 */
function callContract({ contract, method, args, overrides, }) {
