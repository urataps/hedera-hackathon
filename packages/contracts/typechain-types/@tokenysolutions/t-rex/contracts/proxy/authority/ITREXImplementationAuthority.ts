...
export type ImplementationAuthorityChangedEventFilter =
  TypedEventFilter<ImplementationAuthorityChangedEvent>;
...
export type TREXVersionAddedEventFilter =
  TypedEventFilter<TREXVersionAddedEvent>;
...
export type TREXVersionFetchedEventFilter =
  TypedEventFilter<TREXVersionFetchedEvent>;
...
export interface ITREXImplementationAuthority extends BaseContract {
  ...
  functions: {
    ...
    changeImplementationAuthority(
      ...
      _newImplementationAuthority: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    ): Promise<[ITREXImplementationAuthority.TREXContractsStructOutput]>;

    getCurrentVersion(
      overrides?: CallOverrides
    ): Promise<[ITREXImplementationAuthority.VersionStructOutput]>;
  ...
  filters: {
    "IAFactorySet(address)"(
      iaFactory?: PromiseOrValue<string> | null
    ): IAFactorySetEventFilter;
    IAFactorySet(
      iaFactory?: PromiseOrValue<string> | null
    ): IAFactorySetEventFilter;

    "ImplementationAuthorityChanged(address,address)"(
      _token?: PromiseOrValue<string> | null,
      _newImplementationAuthority?: PromiseOrValue<string> | null
    ): ImplementationAuthorityChangedEventFilter;
    ImplementationAuthorityChanged(
      _token?: PromiseOrValue<string> | null,
      _newImplementationAuthority?: PromiseOrValue<string> | null
    ): ImplementationAuthorityChangedEventFilter;

    "ImplementationAuthoritySet(bool,address)"(
    ...
    "TREXFactorySet(address)"(
      trexFactory?: PromiseOrValue<string> | null
    ): TREXFactorySetEventFilter;
    TREXFactorySet(
      trexFactory?: PromiseOrValue<string> | null
    ): TREXFactorySetEventFilter;

    "TREXVersionAdded(tuple,tuple)"(
      version?: ITREXImplementationAuthority.VersionStruct | null,
      trex?: ITREXImplementationAuthority.TREXContractsStruct | null
    ): TREXVersionAddedEventFilter;
    TREXVersionAdded(
      version?: ITREXImplementationAuthority.VersionStruct | null,
      trex?: ITREXImplementationAuthority.TREXContractsStruct | null
    ): TREXVersionAddedEventFilter;

    "TREXVersionFetched(tuple,tuple)"(
      version?: ITREXImplementationAuthority.VersionStruct | null,
      trex?: ITREXImplementationAuthority.TREXContractsStruct | null
    ): TREXVersionFetchedEventFilter;
    TREXVersionFetched(
      version?: ITREXImplementationAuthority.VersionStruct | null,
      trex?: ITREXImplementationAuthority.TREXContractsStruct | null
    ): TREXVersionFetchedEventFilter;

    "VersionUpdated(tuple)"(
      version?: ITREXImplementationAuthority.VersionStruct | null
    ): VersionUpdatedEventFilter;
    VersionUpdated(
      version?: ITREXImplementationAuthority.VersionStruct | null
    ): VersionUpdatedEventFilter;
  };
