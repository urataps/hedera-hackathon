...
} from "../../../../../../@tokenysolutions/t-rex/contracts/proxy/authority/ITREXImplementationAuthority";
...
export class ITREXImplementationAuthority__factory {
  ...
  static createInterface(): ITREXImplementationAuthorityInterface {
    return new utils.Interface(_abi) as ITREXImplementationAuthorityInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as ITREXImplementationAuthority;
  }
}
