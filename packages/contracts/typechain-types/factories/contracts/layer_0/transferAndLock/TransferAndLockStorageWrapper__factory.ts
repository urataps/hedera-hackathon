...
import type {
  ...
  TransferAndLockStorageWrapperInterface,
} from "../../../../contracts/layer_0/transferAndLock/TransferAndLockStorageWrapper";
...
export class TransferAndLockStorageWrapper__factory {
  static readonly abi = _abi;
  static createInterface(): TransferAndLockStorageWrapperInterface {
    return new utils.Interface(_abi) as TransferAndLockStorageWrapperInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as TransferAndLockStorageWrapper;
  }
}
