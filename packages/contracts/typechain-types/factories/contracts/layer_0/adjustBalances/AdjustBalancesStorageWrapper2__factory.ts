...
import type {
  ...
  AdjustBalancesStorageWrapper2Interface,
} from "../../../../contracts/layer_0/adjustBalances/AdjustBalancesStorageWrapper2";
...
export class AdjustBalancesStorageWrapper2__factory {
  static readonly abi = _abi;
  static createInterface(): AdjustBalancesStorageWrapper2Interface {
    return new utils.Interface(_abi) as AdjustBalancesStorageWrapper2Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as AdjustBalancesStorageWrapper2;
  }
}
