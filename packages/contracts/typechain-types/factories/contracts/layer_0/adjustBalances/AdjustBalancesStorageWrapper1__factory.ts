...
import type {
  ...
  AdjustBalancesStorageWrapper1Interface,
} from "../../../../contracts/layer_0/adjustBalances/AdjustBalancesStorageWrapper1";
...
export class AdjustBalancesStorageWrapper1__factory {
  static readonly abi = _abi;
  static createInterface(): AdjustBalancesStorageWrapper1Interface {
    return new utils.Interface(_abi) as AdjustBalancesStorageWrapper1Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as AdjustBalancesStorageWrapper1;
  }
}
