...
import type {
  LockStorageWrapper2,
  LockStorageWrapper2Interface,
} from "../../../../contracts/layer_0/lock/LockStorageWrapper2";
...
export class LockStorageWrapper2__factory {
  static readonly abi = _abi;
  static createInterface(): LockStorageWrapper2Interface {
    return new utils.Interface(_abi) as LockStorageWrapper2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LockStorageWrapper2 {
    return new Contract(address, _abi, signerOrProvider) as LockStorageWrapper2;
  }
}
