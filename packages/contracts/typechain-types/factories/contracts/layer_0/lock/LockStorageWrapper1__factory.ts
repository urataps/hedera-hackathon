...
import type {
  LockStorageWrapper1,
  LockStorageWrapper1Interface,
} from "../../../../contracts/layer_0/lock/LockStorageWrapper1";
...
export class LockStorageWrapper1__factory {
  static readonly abi = _abi;
  static createInterface(): LockStorageWrapper1Interface {
    return new utils.Interface(_abi) as LockStorageWrapper1Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LockStorageWrapper1 {
    return new Contract(address, _abi, signerOrProvider) as LockStorageWrapper1;
  }
}
