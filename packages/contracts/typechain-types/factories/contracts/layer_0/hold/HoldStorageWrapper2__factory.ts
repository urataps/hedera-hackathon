...
import type {
  HoldStorageWrapper2,
  HoldStorageWrapper2Interface,
} from "../../../../contracts/layer_0/hold/HoldStorageWrapper2";
...
export class HoldStorageWrapper2__factory {
  static readonly abi = _abi;
  static createInterface(): HoldStorageWrapper2Interface {
    return new utils.Interface(_abi) as HoldStorageWrapper2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): HoldStorageWrapper2 {
    return new Contract(address, _abi, signerOrProvider) as HoldStorageWrapper2;
  }
}
