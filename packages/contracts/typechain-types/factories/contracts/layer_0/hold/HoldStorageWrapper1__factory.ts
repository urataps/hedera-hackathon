...
import type {
  HoldStorageWrapper1,
  HoldStorageWrapper1Interface,
} from "../../../../contracts/layer_0/hold/HoldStorageWrapper1";
...
export class HoldStorageWrapper1__factory {
  static readonly abi = _abi;
  static createInterface(): HoldStorageWrapper1Interface {
    return new utils.Interface(_abi) as HoldStorageWrapper1Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): HoldStorageWrapper1 {
    return new Contract(address, _abi, signerOrProvider) as HoldStorageWrapper1;
  }
}
