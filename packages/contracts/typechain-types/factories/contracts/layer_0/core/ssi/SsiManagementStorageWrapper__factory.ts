...
import type {
  ...
  SsiManagementStorageWrapperInterface,
} from "../../../../../contracts/layer_0/core/ssi/SsiManagementStorageWrapper";
...
export class SsiManagementStorageWrapper__factory {
  static readonly abi = _abi;
  static createInterface(): SsiManagementStorageWrapperInterface {
    return new utils.Interface(_abi) as SsiManagementStorageWrapperInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as SsiManagementStorageWrapper;
  }
}
