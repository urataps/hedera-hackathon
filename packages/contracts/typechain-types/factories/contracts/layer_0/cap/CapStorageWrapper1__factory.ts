...
import type {
  CapStorageWrapper1,
  CapStorageWrapper1Interface,
} from "../../../../contracts/layer_0/cap/CapStorageWrapper1";
...
export class CapStorageWrapper1__factory {
  static readonly abi = _abi;
  static createInterface(): CapStorageWrapper1Interface {
    return new utils.Interface(_abi) as CapStorageWrapper1Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CapStorageWrapper1 {
    return new Contract(address, _abi, signerOrProvider) as CapStorageWrapper1;
  }
}
