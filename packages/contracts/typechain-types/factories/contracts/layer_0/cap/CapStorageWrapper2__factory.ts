...
import type {
  CapStorageWrapper2,
  CapStorageWrapper2Interface,
} from "../../../../contracts/layer_0/cap/CapStorageWrapper2";
...
export class CapStorageWrapper2__factory {
  static readonly abi = _abi;
  static createInterface(): CapStorageWrapper2Interface {
    return new utils.Interface(_abi) as CapStorageWrapper2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CapStorageWrapper2 {
    return new Contract(address, _abi, signerOrProvider) as CapStorageWrapper2;
  }
}
