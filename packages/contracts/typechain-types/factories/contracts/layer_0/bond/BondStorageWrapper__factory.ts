...
import type {
  BondStorageWrapper,
  BondStorageWrapperInterface,
} from "../../../../contracts/layer_0/bond/BondStorageWrapper";
...
export class BondStorageWrapper__factory {
  static readonly abi = _abi;
  static createInterface(): BondStorageWrapperInterface {
    return new utils.Interface(_abi) as BondStorageWrapperInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BondStorageWrapper {
    return new Contract(address, _abi, signerOrProvider) as BondStorageWrapper;
  }
}
