...
import type {
  ...
  ScheduledTasksCommonInterface,
} from "../../../../contracts/layer_0/scheduledTasks/ScheduledTasksCommon";
...
export class ScheduledTasksCommon__factory {
  static readonly abi = _abi;
  static createInterface(): ScheduledTasksCommonInterface {
    return new utils.Interface(_abi) as ScheduledTasksCommonInterface;
  }
  static connect(
    address: string,
