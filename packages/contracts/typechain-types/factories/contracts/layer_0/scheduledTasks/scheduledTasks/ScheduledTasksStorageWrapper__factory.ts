...
import type {
  ...
  ScheduledTasksStorageWrapperInterface,
} from "../../../../../contracts/layer_0/scheduledTasks/scheduledTasks/ScheduledTasksStorageWrapper";
...
export class ScheduledTasksStorageWrapper__factory {
  static readonly abi = _abi;
  static createInterface(): ScheduledTasksStorageWrapperInterface {
    return new utils.Interface(_abi) as ScheduledTasksStorageWrapperInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as ScheduledTasksStorageWrapper;
  }
}
