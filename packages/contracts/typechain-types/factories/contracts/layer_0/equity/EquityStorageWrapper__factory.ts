...
import type {
  ...
  EquityStorageWrapperInterface,
} from "../../../../contracts/layer_0/equity/EquityStorageWrapper";
...
export class EquityStorageWrapper__factory {
  static readonly abi = _abi;
  static createInterface(): EquityStorageWrapperInterface {
    return new utils.Interface(_abi) as EquityStorageWrapperInterface;
  }
  static connect(
    address: string,
