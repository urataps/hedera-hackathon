...
import type {
  TRexIDiamondLoupe,
  TRexIDiamondLoupeInterface,
} from "../../../../../../contracts/factory/ERC3643/interfaces/IDiamondLoupe.sol/TRexIDiamondLoupe";
...
export class TRexIDiamondLoupe__factory {
  static readonly abi = _abi;
  static createInterface(): TRexIDiamondLoupeInterface {
    return new utils.Interface(_abi) as TRexIDiamondLoupeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TRexIDiamondLoupe {
    return new Contract(address, _abi, signerOrProvider) as TRexIDiamondLoupe;
  }
}
