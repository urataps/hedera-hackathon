...
import type {
  TRexIFactory,
  TRexIFactoryInterface,
} from "../../../../../../contracts/factory/ERC3643/interfaces/IFactory.sol/TRexIFactory";
...
export class TRexIFactory__factory {
  static readonly abi = _abi;
  static createInterface(): TRexIFactoryInterface {
    return new utils.Interface(_abi) as TRexIFactoryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TRexIFactory {
    return new Contract(address, _abi, signerOrProvider) as TRexIFactory;
  }
}
