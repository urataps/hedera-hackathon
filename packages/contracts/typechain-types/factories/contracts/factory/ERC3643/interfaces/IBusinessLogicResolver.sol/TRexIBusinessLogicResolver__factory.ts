...
import type {
  TRexIBusinessLogicResolver,
  TRexIBusinessLogicResolverInterface,
} from "../../../../../../contracts/factory/ERC3643/interfaces/IBusinessLogicResolver.sol/TRexIBusinessLogicResolver";
    ...
    inputs: [
      {
        ...
        indexed: false,
        internalType:
          "struct TRexIBusinessLogicResolver.BusinessLogicRegistryData[]",
        name: "businessLogics",
        type: "tuple[]",
      },
      {
...
export class TRexIBusinessLogicResolver__factory {
  static readonly abi = _abi;
  static createInterface(): TRexIBusinessLogicResolverInterface {
    return new utils.Interface(_abi) as TRexIBusinessLogicResolverInterface;
  }
  static connect(
    address: string,
