...
import type {
  Freeze,
  FreezeInterface,
} from "../../../../contracts/layer_1/freeze/Freeze";
...
export class Freeze__factory {
  static readonly abi = _abi;
  static createInterface(): FreezeInterface {
    return new utils.Interface(_abi) as FreezeInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Freeze {
    return new Contract(address, _abi, signerOrProvider) as Freeze;
  }
}
