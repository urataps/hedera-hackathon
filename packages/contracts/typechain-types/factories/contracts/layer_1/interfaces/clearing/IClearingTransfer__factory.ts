...
import type {
  IClearingTransfer,
  IClearingTransferInterface,
} from "../../../../../contracts/layer_1/interfaces/clearing/IClearingTransfer";
...
export class IClearingTransfer__factory {
  static readonly abi = _abi;
  static createInterface(): IClearingTransferInterface {
    return new utils.Interface(_abi) as IClearingTransferInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IClearingTransfer {
    return new Contract(address, _abi, signerOrProvider) as IClearingTransfer;
  }
}
