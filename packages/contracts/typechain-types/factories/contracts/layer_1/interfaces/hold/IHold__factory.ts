...
import type {
  IHold,
  IHoldInterface,
} from "../../../../../contracts/layer_1/interfaces/hold/IHold";
...
export class IHold__factory {
  static readonly abi = _abi;
  static createInterface(): IHoldInterface {
    return new utils.Interface(_abi) as IHoldInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): IHold {
    return new Contract(address, _abi, signerOrProvider) as IHold;
  }
}
