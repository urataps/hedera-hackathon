...
import type {
  Pause,
  PauseInterface,
} from "../../../../contracts/layer_1/pause/Pause";
...
export class Pause__factory {
  static readonly abi = _abi;
  static createInterface(): PauseInterface {
    return new utils.Interface(_abi) as PauseInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Pause {
    return new Contract(address, _abi, signerOrProvider) as Pause;
  }
}
