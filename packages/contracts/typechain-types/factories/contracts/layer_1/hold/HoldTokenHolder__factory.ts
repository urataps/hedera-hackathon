...
import type {
  HoldTokenHolder,
  HoldTokenHolderInterface,
} from "../../../../contracts/layer_1/hold/HoldTokenHolder";
...
export class HoldTokenHolder__factory {
  static readonly abi = _abi;
  static createInterface(): HoldTokenHolderInterface {
    return new utils.Interface(_abi) as HoldTokenHolderInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): HoldTokenHolder {
    return new Contract(address, _abi, signerOrProvider) as HoldTokenHolder;
  }
}
