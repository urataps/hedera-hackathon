...
import type {
  HoldManagement,
  HoldManagementInterface,
} from "../../../../contracts/layer_1/hold/HoldManagement";
...
export class HoldManagement__factory {
  static readonly abi = _abi;
  static createInterface(): HoldManagementInterface {
    return new utils.Interface(_abi) as HoldManagementInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): HoldManagement {
    return new Contract(address, _abi, signerOrProvider) as HoldManagement;
  }
}
