...
import type {
  HoldRead,
  HoldReadInterface,
} from "../../../../contracts/layer_1/hold/HoldRead";
...
export class HoldRead__factory {
  static readonly abi = _abi;
  static createInterface(): HoldReadInterface {
    return new utils.Interface(_abi) as HoldReadInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): HoldRead {
    return new Contract(address, _abi, signerOrProvider) as HoldRead;
  }
}
