...
import type {
  ...
  ITimeTravelStorageWrapperInterface,
} from "../../../../../contracts/test/testTimeTravel/interfaces/ITimeTravelStorageWrapper";
...
export class ITimeTravelStorageWrapper__factory {
  static readonly abi = _abi;
  static createInterface(): ITimeTravelStorageWrapperInterface {
    return new utils.Interface(_abi) as ITimeTravelStorageWrapperInterface;
  }
  static connect(
    address: string,
