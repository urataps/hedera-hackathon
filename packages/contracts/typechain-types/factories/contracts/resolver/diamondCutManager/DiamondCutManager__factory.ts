...
import type {
  DiamondCutManager,
  DiamondCutManagerInterface,
} from "../../../../contracts/resolver/diamondCutManager/DiamondCutManager";
...
export class DiamondCutManager__factory {
  static readonly abi = _abi;
  static createInterface(): DiamondCutManagerInterface {
    return new utils.Interface(_abi) as DiamondCutManagerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): DiamondCutManager {
    return new Contract(address, _abi, signerOrProvider) as DiamondCutManager;
  }
}
