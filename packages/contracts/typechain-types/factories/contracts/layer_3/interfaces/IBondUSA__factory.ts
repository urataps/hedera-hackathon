...
import type {
  IBondUSA,
  IBondUSAInterface,
} from "../../../../contracts/layer_3/interfaces/IBondUSA";
...
export class IBondUSA__factory {
  static readonly abi = _abi;
  static createInterface(): IBondUSAInterface {
    return new utils.Interface(_abi) as IBondUSAInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IBondUSA {
    return new Contract(address, _abi, signerOrProvider) as IBondUSA;
  }
}
