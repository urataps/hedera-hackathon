...
import type {
  IEquityUSA,
  IEquityUSAInterface,
} from "../../../../contracts/layer_3/interfaces/IEquityUSA";
...
export class IEquityUSA__factory {
  static readonly abi = _abi;
  static createInterface(): IEquityUSAInterface {
    return new utils.Interface(_abi) as IEquityUSAInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IEquityUSA {
    return new Contract(address, _abi, signerOrProvider) as IEquityUSA;
  }
}
