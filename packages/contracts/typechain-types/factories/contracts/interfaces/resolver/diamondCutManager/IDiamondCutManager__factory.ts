...
import type {
  IDiamondCutManager,
  IDiamondCutManagerInterface,
} from "../../../../../contracts/interfaces/resolver/diamondCutManager/IDiamondCutManager";
...
export class IDiamondCutManager__factory {
  static readonly abi = _abi;
  static createInterface(): IDiamondCutManagerInterface {
    return new utils.Interface(_abi) as IDiamondCutManagerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IDiamondCutManager {
    return new Contract(address, _abi, signerOrProvider) as IDiamondCutManager;
  }
}
