...
import type {
  Equity,
  EquityInterface,
} from "../../../../contracts/layer_2/equity/Equity";
...
export class Equity__factory {
  static readonly abi = _abi;
  static createInterface(): EquityInterface {
    return new utils.Interface(_abi) as EquityInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Equity {
    return new Contract(address, _abi, signerOrProvider) as Equity;
  }
}
