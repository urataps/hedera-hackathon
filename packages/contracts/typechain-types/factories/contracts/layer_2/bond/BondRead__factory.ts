...
import type {
  BondRead,
  BondReadInterface,
} from "../../../../contracts/layer_2/bond/BondRead";
...
export class BondRead__factory {
  static readonly abi = _abi;
  static createInterface(): BondReadInterface {
    return new utils.Interface(_abi) as BondReadInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BondRead {
    return new Contract(address, _abi, signerOrProvider) as BondRead;
  }
}
