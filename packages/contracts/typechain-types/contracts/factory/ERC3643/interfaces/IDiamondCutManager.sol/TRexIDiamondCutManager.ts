...
export type DiamondConfigurationCreatedEvent = TypedEvent<
  [string, TRexIDiamondCutManager.FacetConfigurationStructOutput[], BigNumber],
...
export interface TRexIDiamondCutManager extends BaseContract {
  ...
  functions: {
    ...
    createBatchConfiguration(
      _configurationId: PromiseOrValue<BytesLike>,
      _facetConfigurations: TRexIDiamondCutManager.FacetConfigurationStruct[],
      _isLastBatch: PromiseOrValue<boolean>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "DiamondBatchConfigurationCreated(bytes32,tuple[],bool,uint256)"(
      configurationId?: null,
    ...
    "DiamondConfigurationCreated(bytes32,tuple[],uint256)"(
      configurationId?: null,
      facetConfigurations?: null,
      version?: null
