...
export interface IFactoryInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [IFactory.BondDataStruct, FactoryRegulationDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "deployEquity",
    values: [IFactory.EquityDataStruct, FactoryRegulationDataStruct]
  ): string;
  encodeFunctionData(
...
export interface IFactory extends BaseContract {
  ...
  functions: {
    deployBond(
      _bondData: IFactory.BondDataStruct,
      _factoryRegulationData: FactoryRegulationDataStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    deployEquity(
      _equityData: IFactory.EquityDataStruct,
      _factoryRegulationData: FactoryRegulationDataStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
