...
export declare namespace IClearing {
  ...
  export type ClearingRedeemDataStruct = {
    amount: PromiseOrValue<BigNumberish>;
    expirationTimestamp: PromiseOrValue<BigNumberish>;
    data: PromiseOrValue<BytesLike>;
    operatorData: PromiseOrValue<BytesLike>;
  ...
  export type ClearingRedeemDataStructOutput = [
    BigNumber,
    BigNumber,
    string,
    string,
...
export interface ClearingRedeemFacetTimeTravelInterface
  ...
  encodeFunctionData(
    functionFragment: "clearingRedeemByPartition",
    values: [IClearing.ClearingOperationStruct, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "clearingRedeemFromByPartition",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "getClearingRedeemForByPartition",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "operatorClearingRedeemByPartition",
    values: [
      IClearing.ClearingOperationFromStruct,
      PromiseOrValue<BigNumberish>
    ]
  ...
  encodeFunctionData(
    functionFragment: "protectedClearingRedeemByPartition",
    values: [
...
export interface ClearingRedeemFacetTimeTravel extends BaseContract {
  ...
  getClearingRedeemForByPartition(
    ...
    _clearingId: PromiseOrValue<BigNumberish>,
    overrides?: CallOverrides
  ): Promise<IClearing.ClearingRedeemDataStructOutput>;
