...
export declare namespace IBondRead {
  ...
  export type RegisteredCouponStructOutput = [
    ...
    BigNumber
  ] & { coupon: IBondRead.CouponStructOutput; snapshotId: BigNumber };
...
export interface BondUSAReadTimeTravel extends BaseContract {
  ...
  getBondDetails(
    overrides?: CallOverrides
  ): Promise<IBondRead.BondDetailsDataStructOutput>;

  getCoupon(
    _couponID: PromiseOrValue<BigNumberish>,
    overrides?: CallOverrides
  ): Promise<IBondRead.RegisteredCouponStructOutput>;

  getCouponCount(overrides?: CallOverrides): Promise<BigNumber>;

  getCouponDetails(
    overrides?: CallOverrides
  ): Promise<IBondRead.CouponDetailsDataStructOutput>;

  getCouponFor(
    _couponID: PromiseOrValue<BigNumberish>,
    _account: PromiseOrValue<string>,
    overrides?: CallOverrides
  ): Promise<IBondRead.CouponForStructOutput>;
