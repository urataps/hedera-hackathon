...
export interface SnapshotsTimeTravelInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "clearedBalanceOfAtSnapshot",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "clearedBalanceOfAtSnapshotByPartition",
    values: [
      PromiseOrValue<BytesLike>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>
  ...
  encodeFunctionData(
    functionFragment: "heldBalanceOfAtSnapshot",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "heldBalanceOfAtSnapshotByPartition",
    values: [
      PromiseOrValue<BytesLike>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<string>
