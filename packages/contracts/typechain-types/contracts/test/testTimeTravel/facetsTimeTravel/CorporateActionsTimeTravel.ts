...
export interface CorporateActionsTimeTravel extends BaseContract {
  ...
  functions: {
    addCorporateAction(
      _actionType: PromiseOrValue<BytesLike>,
      _data: PromiseOrValue<BytesLike>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    getCorporateAction(
      _corporateActionId: PromiseOrValue<BytesLike>,
  ...
  filters: {
    ...
    "CorporateActionAdded(address,bytes32,bytes32,uint256,bytes)"(
      operator?: PromiseOrValue<string> | null,
      actionType?: PromiseOrValue<BytesLike> | null,
      corporateActionId?: PromiseOrValue<BytesLike> | null,
