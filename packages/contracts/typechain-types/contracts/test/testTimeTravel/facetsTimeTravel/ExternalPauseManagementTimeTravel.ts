...
export interface ExternalPauseManagementTimeTravelInterface
  ...
  encodeFunctionData(
    functionFragment: "addExternalPause",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "getExternalPausesCount",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getExternalPausesMembers",
  ...
  encodeFunctionData(
    functionFragment: "initialize_ExternalPauses",
    values: [PromiseOrValue<string>[]]
  ): string;
  encodeFunctionData(
    functionFragment: "isExternalPause",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "removeExternalPause",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "updateExternalPauses",
...
export type AddedToExternalPausesEventFilter =
  TypedEventFilter<AddedToExternalPausesEvent>;
...
export type ExternalPausesUpdatedEventFilter =
  TypedEventFilter<ExternalPausesUpdatedEvent>;
...
export type RemovedFromExternalPausesEventFilter =
  TypedEventFilter<RemovedFromExternalPausesEvent>;
...
export interface ExternalPauseManagementTimeTravel extends BaseContract {
  ...
  functions: {
    addExternalPause(
      _pause: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    getExternalPausesCount(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { externalPausesCount_: BigNumber }>;
  ...
  filters: {
    "AddedToExternalPauses(address,address)"(
      operator?: PromiseOrValue<string> | null,
      pause?: null
    ): AddedToExternalPausesEventFilter;
    ...
    "ExternalPausesUpdated(address,address[],bool[])"(
      operator?: PromiseOrValue<string> | null,
      pauses?: null,
      actives?: null
    ): ExternalPausesUpdatedEventFilter;
    ...
    "RemovedFromExternalPauses(address,address)"(
      operator?: PromiseOrValue<string> | null,
      pause?: null
    ): RemovedFromExternalPausesEventFilter;
