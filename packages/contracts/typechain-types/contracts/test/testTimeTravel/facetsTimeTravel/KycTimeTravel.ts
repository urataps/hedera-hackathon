...
export interface KycTimeTravel extends BaseContract {
  ...
  functions: {
    ...
    getKycAccountsCount(
      _kycStatus: PromiseOrValue<BigNumberish>,
    ...
    grantKyc(
      _account: PromiseOrValue<string>,
      _vcId: PromiseOrValue<string>,
      _validFrom: PromiseOrValue<BigNumberish>,
      _validTo: PromiseOrValue<BigNumberish>,
      _issuer: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    initializeInternalKyc(
      _internalKycActivated: PromiseOrValue<boolean>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
