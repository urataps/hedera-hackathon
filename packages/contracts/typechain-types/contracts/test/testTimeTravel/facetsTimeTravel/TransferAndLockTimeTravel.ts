...
export declare namespace ITransferAndLock {
  export type TransferAndLockStructStruct = {
  ...
  export type TransferAndLockStructStructOutput = [
    string,
    string,
    BigNumber,
    string,
...
export interface TransferAndLockTimeTravelInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "protectedTransferAndLock",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "protectedTransferAndLockByPartition",
    values: [
      PromiseOrValue<BytesLike>,
      ITransferAndLock.TransferAndLockStructStruct,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "transferAndLockByPartition",
    values: [
      PromiseOrValue<BytesLike>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
...
export interface TransferAndLockTimeTravel extends BaseContract {
  ...
  functions: {
    ...
    protectedTransferAndLock(
      _transferAndLockData: ITransferAndLock.TransferAndLockStructStruct,
    ...
    transferAndLock(
      ...
      _expirationTimestamp: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
