...
export declare namespace IERC20 {
  ...
  export type ERC20MetadataStructOutput = [
    ...
    number
  ] & { info: IERC20.ERC20MetadataInfoStructOutput; securityType: number };
}
...
export interface ERC20TimeTravelInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [IERC20.ERC20MetadataStruct]
  ): string;
...
export interface ERC20TimeTravel extends BaseContract {
  ...
  functions: {
    ...
    getERC20Metadata(
      overrides?: CallOverrides
    ): Promise<[IERC20.ERC20MetadataStructOutput]>;
    ...
    initialize_ERC20(
      erc20Metadata: IERC20.ERC20MetadataStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
