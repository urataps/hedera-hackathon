...
export interface ERC20VotesTimeTravelInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "initialize_ERC20Votes",
...
export interface ERC20VotesTimeTravel extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[IERC20Votes.CheckpointStructOutput]>;
    ...
    getPastTotalSupply(
      _timepoint: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
    ...
    initialize_ERC20Votes(
      _activated: PromiseOrValue<boolean>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
