...
export class RemoveExternalKycListCommandHandler
  implements ICommandHandler<RemoveExternalKycListCommand>
{
  constructor(
  ...
  async execute(
    command: RemoveExternalKycListCommand,
  ): Promise<RemoveExternalKycListCommandResponse> {
    try {
      ...
      const res = await handler.removeExternalKycList(
        securityEvmAddress,
      ...
      return Promise.resolve(
        new RemoveExternalKycListCommandResponse(
          res.error === undefined,
          res.id!,
        ),
      );
