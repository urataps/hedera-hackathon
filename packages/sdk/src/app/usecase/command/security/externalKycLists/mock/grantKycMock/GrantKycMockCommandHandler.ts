...
export class GrantKycMockCommandHandler
  implements ICommandHandler<GrantKycMockCommand>
{
  constructor(
  ...
  async execute(
    command: GrantKycMockCommand,
  ): Promise<GrantKycMockCommandResponse> {
    try {
      ...
      const res = await handler.grantKycMock(
        contractEvmAddress,
        targetEvmAddress,
        contractId,
      );
      ...
      return Promise.resolve(
        new GrantKycMockCommandResponse(res.error === undefined, res.id!),
      );
    } catch (error) {
