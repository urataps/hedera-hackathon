...
export class AddToBlackListMockCommandHandler
  implements ICommandHandler<AddToBlackListMockCommand>
{
  constructor(
  ...
  async execute(
    command: AddToBlackListMockCommand,
  ): Promise<AddToBlackListMockCommandResponse> {
    try {
      ...
      const res = await handler.addToBlackListMock(
        contractEvmAddress,
        targetEvmAddress,
        contractId,
      );
      ...
      return Promise.resolve(
        new AddToBlackListMockCommandResponse(res.error === undefined, res.id!),
      );
    } catch (error) {
