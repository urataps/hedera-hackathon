  ...
  describe('execute', () => {
    describe('error cases', () => {
      it('throws RemoveFromControlListCommandError when command fails with uncaught error', async () => {
        ...
        await expect(resultPromise).rejects.toBeInstanceOf(
          RemoveFromControlListCommandError,
        );

        await expect(resultPromise).rejects.toMatchObject({
          message: expect.stringContaining(
            `An error occurred while removing user from control list: ${errorMsg}`,
          ),
    ...
    describe('success cases', () => {
      it('should successfully add to control list', async () => {
        ...
        transactionServiceMock
          .getHandler()
          .removeFromControlList.mockResolvedValue({
            id: transactionId,
          });
        ...
        expect(
          transactionServiceMock.getHandler().removeFromControlList,
