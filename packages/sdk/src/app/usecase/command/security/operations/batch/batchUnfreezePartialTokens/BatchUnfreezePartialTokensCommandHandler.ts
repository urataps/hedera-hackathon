...
export class BatchUnfreezePartialTokensCommandHandler
  implements ICommandHandler<BatchUnfreezePartialTokensCommand>
{
  constructor(
  ...
  async execute(
    command: BatchUnfreezePartialTokensCommand,
  ): Promise<BatchUnfreezePartialTokensResponse> {
    try {
      ...
      const res = await handler.batchUnfreezePartialTokens(
        securityEvmAddress,
        bdList,
        evmAddresses,
        securityId,
      ...
      return Promise.resolve(
        new BatchUnfreezePartialTokensResponse(
          res.error === undefined,
          res.id!,
        ),
      );
