...
export class ClearingRedeemByPartitionCommandHandler
  implements ICommandHandler<ClearingRedeemByPartitionCommand>
{
  constructor(
  ...
  async execute(
    command: ClearingRedeemByPartitionCommand,
  ): Promise<ClearingRedeemByPartitionCommandResponse> {
    try {
