...
} from './FreezePartialTokensCommand';
  ...
  implements ICommandHandler<FreezePartialTokensCommand>
{
  ...
  async execute(
    command: FreezePartialTokensCommand,
  ): Promise<FreezePartialTokensResponse> {
    try {
      ...
      return Promise.resolve(
        new FreezePartialTokensResponse(res.error === undefined, res.id!),
      );
    } catch (error) {
