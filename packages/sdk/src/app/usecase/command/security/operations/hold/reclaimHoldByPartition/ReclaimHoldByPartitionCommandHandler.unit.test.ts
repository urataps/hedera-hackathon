  ...
  describe('execute', () => {
    describe('error cases', () => {
      it('throws ReclaimHoldByPartitionCommandError when command fails with uncaught error', async () => {
        ...
        await expect(resultPromise).rejects.toBeInstanceOf(
          ReclaimHoldByPartitionCommandError,
        );

        await expect(resultPromise).rejects.toMatchObject({
          message: expect.stringContaining(
            `An error occurred while reclaiming hold: ${errorMsg}`,
          ),
    ...
    describe('success cases', () => {
      it('should successfully reclaim hold', async () => {
        ...
        transactionServiceMock
          .getHandler()
          .reclaimHoldByPartition.mockResolvedValue({
            id: transactionId,
          });
        ...
        expect(
          transactionServiceMock.getHandler().reclaimHoldByPartition,
