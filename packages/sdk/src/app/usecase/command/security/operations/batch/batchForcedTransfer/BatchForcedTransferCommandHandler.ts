...
} from './BatchForcedTransferCommand';
import BigDecimal from '@domain/context/shared/BigDecimal';
import SecurityService from '@service/security/SecurityService';
import { KycStatus } from '@domain/context/kyc/Kyc';

@CommandHandler(BatchForcedTransferCommand)
export class BatchForcedTransferCommandHandler
  implements ICommandHandler<BatchForcedTransferCommand>
{
  constructor(
  ...
  async execute(
    command: BatchForcedTransferCommand,
  ): Promise<BatchForcedTransferResponse> {
    try {
      ...
      return Promise.resolve(
        new BatchForcedTransferResponse(res.error === undefined, res.id!),
      );
    } catch (error) {
