...
describe('GetScheduledBalanceAdjustmentCountQueryHandler', () => {
  ...
  beforeEach(() => {
    handler = new GetScheduledBalanceAdjustmentCountQueryHandler(
  ...
  describe('execute', () => {
    ...
    it('should successfully get scheduled balance adjustment count', async () => {
      ...
      queryAdapterServiceMock.getScheduledBalanceAdjustmentCount.mockResolvedValue(
        1,
      );
      ...
      expect(
        queryAdapterServiceMock.getScheduledBalanceAdjustmentCount,
