...
export class GetVotingHoldersQueryHandler
  implements IQueryHandler<GetVotingHoldersQuery>
{
  constructor(
  ...
  async execute(
    query: GetVotingHoldersQuery,
  ): Promise<GetVotingHoldersQueryResponse> {
    try {
      ...
      const res = await this.queryAdapter.getVotingHolders(
        securityEvmAddress,
        voteId,
        start,
        end,
