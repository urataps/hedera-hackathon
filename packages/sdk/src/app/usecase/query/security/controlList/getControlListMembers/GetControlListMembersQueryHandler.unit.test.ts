...
} from './GetControlListMembersQuery';
...
describe('GetControlListMembersQueryHandler', () => {
  ...
  beforeEach(() => {
    handler = new GetControlListMembersQueryHandler(
  ...
  describe('execute', () => {
    it('throws GetControlListMembersQueryError when query fails with uncaught error', async () => {
      ...
      await expect(resultPromise).rejects.toMatchObject({
        message: expect.stringContaining(
          `An error occurred while querying control list members: ${errorMsg}`,
        ),
    ...
    it('should successfully get control list members', async () => {
      ...
      queryAdapterServiceMock.getControlListMembers.mockResolvedValueOnce([
        member,
      ]);
      ...
      expect(
        queryAdapterServiceMock.getControlListMembers,
