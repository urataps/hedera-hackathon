...
export class GetTotalTokenHoldersAtSnapshotQueryHandler
  implements IQueryHandler<GetTotalTokenHoldersAtSnapshotQuery>
{
  constructor(
  ...
  async execute(
    query: GetTotalTokenHoldersAtSnapshotQuery,
  ): Promise<GetTotalTokenHoldersAtSnapshotQueryResponse> {
    try {
      ...
      const res = await this.queryAdapter.getTotalTokenHoldersAtSnapshot(
        securityEvmAddress,
        snapshotId,
      );
