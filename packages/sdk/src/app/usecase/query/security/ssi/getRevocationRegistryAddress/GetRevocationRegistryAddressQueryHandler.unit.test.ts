...
describe('GetRevocationRegistryAddressQueryHandler', () => {
  ...
  const revocation = new EvmAddress(
  ...
  describe('execute', () => {
    it('throws GetRevocationRegistryAddressQueryError when query fails with uncaught error', async () => {
      ...
      await expect(resultPromise).rejects.toBeInstanceOf(
        GetRevocationRegistryAddressQueryError,
      );

      await expect(resultPromise).rejects.toMatchObject({
        message: expect.stringContaining(
          `An error occurred while querying revocation registry address: ${errorMsg}`,
        ),
    ...
    it('should successfully get revocation registry address', async () => {
      ...
      queryAdapterServiceMock.getRevocationRegistryAddress.mockResolvedValueOnce(
        revocation,
      );
