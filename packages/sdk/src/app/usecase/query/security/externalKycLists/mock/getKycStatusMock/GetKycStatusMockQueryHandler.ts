...
export class GetKycStatusMockQueryHandler
  implements IQueryHandler<GetKycStatusMockQuery>
{
  constructor(
  ...
  async execute(
    query: GetKycStatusMockQuery,
  ): Promise<GetKycStatusMockQueryResponse> {
    ...
    const res = await this.queryAdapter.getKycStatusMock(
      contractEvmAddress,
      targetEvmAddress,
    );
