...
describe('GetClearingRedeemForByPartitionQueryHandler', () => {
  ...
  describe('execute', () => {
    it('throws GetClearingRedeemForByPartitionQueryError when query fails with uncaught error', async () => {
      ...
      await expect(resultPromise).rejects.toMatchObject({
        message: expect.stringContaining(
          `An error occurred while querying clearing redeem: ${errorMsg}`,
        ),
    ...
    it('should successfully get clearing create redeem for by partition', async () => {
      ...
      queryAdapterServiceMock.getClearingRedeemForByPartition.mockResolvedValueOnce(
        clearing,
      );
      ...
      expect(
        queryAdapterServiceMock.getClearingRedeemForByPartition,
