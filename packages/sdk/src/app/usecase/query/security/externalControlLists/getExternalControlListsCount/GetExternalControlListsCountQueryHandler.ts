...
export class GetExternalControlListsCountQueryHandler
  implements IQueryHandler<GetExternalControlListsCountQuery>
{
  constructor(
  ...
  async execute(
    query: GetExternalControlListsCountQuery,
  ): Promise<GetExternalControlListsCountQueryResponse> {
    ...
    const res =
      await this.queryAdapter.getExternalControlListsCount(securityEvmAddress);
