  ...
  implements IQueryHandler<IsExternalControlListQuery>
{
  ...
  async execute(
    query: IsExternalControlListQuery,
  ): Promise<IsExternalControlListQueryResponse> {
    ...
    const res = await this.queryAdapter.isExternalControlList(
      securityEvmAddress,
