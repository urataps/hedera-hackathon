...
export class IsAuthorizedBlackListMockQueryHandler
  implements IQueryHandler<IsAuthorizedBlackListMockQuery>
{
  constructor(
  ...
  async execute(
    query: IsAuthorizedBlackListMockQuery,
  ): Promise<IsAuthorizedBlackListMockQueryResponse> {
    ...
    const res = await this.queryAdapter.isAuthorizedBlackListMock(
      contractEvmAddress,
      targetEvmAddress,
    );
