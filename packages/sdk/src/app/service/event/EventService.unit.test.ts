...
describe('EventService', () => {
  ...
  describe('getEventEmitter', () => {
    it('should throw EventNotFound for an unregistered event', () => {
      expect(() =>
        (eventService as any).getEventEmitter('invalidEvent'),
      ).toThrow(EventNotFound);
      expect(() =>
        (eventService as any).getEventEmitter('invalidEvent'),
      ).toThrow('WalletEvent (invalidEvent) not registered yet');
    });
  });
  ...
  describe('on', () => {
    it('should throw EventListenerNotFound for an unregistered event', () => {
      ...
      expect(() => eventService.on(invalidEvent, listener)).toThrow(
        EventListenerNotFound,
      );
      expect(() => eventService.on(invalidEvent, listener)).toThrow(
        invalidEvent,
      );
  ...
  describe('emit', () => {
    it('should throw EventNotFound for an unregistered event', () => {
      ...
      expect(() => eventService.emit(invalidEvent, data)).toThrow(
        EventNotFound,
      );
      expect(() => eventService.emit(invalidEvent, data)).toThrow(
