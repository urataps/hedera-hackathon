...
describe('Control List', () => {
  ...
  describe('addToControlList', () => {
    ...
    it('should add to control list successfully', async () => {
      ...
      expect(commandBusMock.execute).toHaveBeenCalledWith(
        new AddToControlListCommand(
          controlListRequest.targetId,
          controlListRequest.securityId,
        ),
      );
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(
        Security.addToControlList(controlListRequest),
  ...
  describe('removeFromControlList', () => {
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(
        Security.removeFromControlList(controlListRequest),
      ).rejects.toThrow('Command execution failed');
  ...
  describe('isAccountInControlList', () => {
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(
        Security.isAccountInControlList(controlListRequest),
  ...
  describe('getControlListCount', () => {
    ...
    it('should get control list count successfully', async () => {
      ...
      const result = await Security.getControlListCount(
        getControlListCountRequest,
      );
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(
        Security.getControlListCount(getControlListCountRequest),
      ).rejects.toThrow('Query execution failed');
  ...
  describe('getControlListMembers', () => {
    ...
    it('should get control list members successfully', async () => {
      ...
      const result = await Security.getControlListMembers(
        getControlListMembersRequest,
      );
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(
        Security.getControlListMembers(getControlListMembersRequest),
      ).rejects.toThrow('Query execution failed');
  ...
  describe('getControlListType', () => {
    ...
    it('should get control list type successfully', async () => {
      ...
      const result = await Security.getControlListType(
        getControlListTypeRequest,
      );
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(
        Security.getControlListType(getControlListTypeRequest),
      ).rejects.toThrow('Query execution failed');
    ...
    it('should throw error if securityId is invalid', async () => {
      ...
      await expect(
        Security.getControlListType(getControlListCountRequest),
      ).rejects.toThrow(ValidationError);
    });
  });
});
