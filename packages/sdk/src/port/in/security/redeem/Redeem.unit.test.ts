...
describe('Redeem', () => {
  ...
  describe('controllerRedeem', () => {
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(
        Security.controllerRedeem(forceRedeemRequest),
  ...
  describe('protectedRedeemFromByPartition', () => {
    ...
    it('should protected redeem from by partition successfully', async () => {
      ...
      const result = await Security.protectedRedeemFromByPartition(
        protectedRedeemFromByPartitionRequest,
      );
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(
        Security.protectedRedeemFromByPartition(
          protectedRedeemFromByPartitionRequest,
        ),
      ).rejects.toThrow('Command execution failed');
  ...
  describe('BatchBurn', () => {
    ...
    it('should batch burn sucessfully', async () => {
      ...
      expect(commandBusMock.execute).toHaveBeenCalledWith(
        new BatchBurnCommand(
          batchBurnRequest.securityId,
          batchBurnRequest.amountList,
          batchBurnRequest.targetList,
        ),
      );
      expect(result).toEqual(expectedResponse);
    });
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(Security.batchBurn(batchBurnRequest)).rejects.toThrow(
        'Command execution failed',
      );
