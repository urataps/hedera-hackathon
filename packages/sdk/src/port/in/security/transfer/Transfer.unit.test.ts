...
describe('Transfer', () => {
  ...
  describe('transfer', () => {
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(Security.transfer(transferRequest)).rejects.toThrow(
  ...
  describe('transferAndLock', () => {
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(
        Security.transferAndLock(transferAndLockRequest),
  ...
  describe('protectedTransferFromByPartition', () => {
    ...
    it('should protected transfer from by partition successfully', async () => {
      ...
      const result = await Security.protectedTransferFromByPartition(
        protectedTransferFromByPartitionRequest,
      );
  ...
  describe('BatchTransfer', () => {
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(
        Security.batchTransfer(batchTransferRequest),
      ).rejects.toThrow('Command execution failed');
  ...
  describe('BatchForcedTransfer', () => {
    ...
    const expectedResponse = new BatchForcedTransferResponse(
      true,
      transactionId,
    );
    it('should batch forced transfer sucessfully', async () => {
      ...
      const result = await Security.batchForcedTransfer(
        batchForcedTransferRequest,
      );
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(
        Security.batchForcedTransfer(batchForcedTransferRequest),
      ).rejects.toThrow('Command execution failed');
