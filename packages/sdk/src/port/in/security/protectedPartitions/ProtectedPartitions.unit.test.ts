...
describe('Protected Partitions', () => {
  ...
  describe('protectPartitions', () => {
    ...
    it('should protect partitions successfully', async () => {
      ...
      const result = await Security.protectPartitions(
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(
        Security.protectPartitions(partitionsProtectedRequest),
  ...
  describe('unprotectPartitions', () => {
    ...
    it('should protect partitions successfully', async () => {
      ...
      const result = await Security.unprotectPartitions(
        partitionsProtectedRequest,
      );
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(
        Security.unprotectPartitions(partitionsProtectedRequest),
      ).rejects.toThrow('Command execution failed');
  ...
  describe('arePartitionsProtected', () => {
    ...
    it('should check are partitions protected successfully', async () => {
      ...
      const result = await Security.arePartitionsProtected(
        partitionsProtectedRequest,
      );
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(
        Security.arePartitionsProtected(partitionsProtectedRequest),
  ...
  describe('getNounce', () => {
    ...
    it('should get nonce successfully', async () => {
      ...
      expect(queryBusMock.execute).toHaveBeenCalledWith(
        new GetNounceQuery(
          getNounceRequest.securityId,
          getNounceRequest.targetId,
        ),
      );
      expect(result).toEqual(expectedResponse.payload);
    });
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(Security.getNounce(getNounceRequest)).rejects.toThrow(
