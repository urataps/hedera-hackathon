...
describe('ExternalPausesManagement', () => {
  ...
  describe('updateExternalPauses', () => {
    ...
    it('should update external pause successfully', async () => {
      ...
      const result = await ExternalPausesManagement.updateExternalPauses(
        updateExternalPausesRequest,
      );
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(
        ExternalPausesManagement.updateExternalPauses(
          updateExternalPausesRequest,
        ),
  ...
  describe('addExternalPause', () => {
    ...
    it('should add external pause successfully', async () => {
      ...
      const result = await ExternalPausesManagement.addExternalPause(
        addExternalPauseRequest,
      );
      ...
      expect(commandBusMock.execute).toHaveBeenCalledWith(
        new AddExternalPauseCommand(
          addExternalPauseRequest.securityId,
          addExternalPauseRequest.externalPauseAddress,
        ),
      );
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(
        ExternalPausesManagement.addExternalPause(addExternalPauseRequest),
      ).rejects.toThrow('Command execution failed');
  ...
  describe('removeExternalPause', () => {
    ...
    it('should remove external pause successfully', async () => {
      ...
      const result = await ExternalPausesManagement.removeExternalPause(
        removeExternalPauseRequest,
      );
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(
        ExternalPausesManagement.removeExternalPause(
          removeExternalPauseRequest,
        ),
      ).rejects.toThrow('Command execution failed');
  ...
  describe('isExternalPause', () => {
    ...
    it('should check if is external pause successfully', async () => {
      ...
      const result = await ExternalPausesManagement.isExternalPause(
        isExternalPauseRequest,
      );
      ...
      expect(queryBusMock.execute).toHaveBeenCalledWith(
        new IsExternalPauseQuery(
          isExternalPauseRequest.securityId,
          isExternalPauseRequest.externalPauseAddress,
        ),
      );
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(
        ExternalPausesManagement.isExternalPause(isExternalPauseRequest),
  ...
  describe('getExternalPausesCount', () => {
    ...
    it('should get external pauses count successfully', async () => {
      ...
      const result = await ExternalPausesManagement.getExternalPausesCount(
        getExternalPausesCountRequest,
      );
      ...
      expect(queryBusMock.execute).toHaveBeenCalledWith(
        new GetExternalPausesCountQuery(
          getExternalPausesCountRequest.securityId,
        ),
      );
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(
        ExternalPausesManagement.getExternalPausesCount(
          getExternalPausesCountRequest,
        ),
      ).rejects.toThrow('Query execution failed');
  ...
  describe('getExternalPausesMembers', () => {
    ...
    it('should get external pauses members successfully', async () => {
      ...
      const result = await ExternalPausesManagement.getExternalPausesMembers(
        getExternalPausesMembersRequest,
      );
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(
        ExternalPausesManagement.getExternalPausesMembers(
          getExternalPausesMembersRequest,
        ),
      ).rejects.toThrow('Query execution failed');
  ...
  describe('setPausedMock', () => {
    ...
    it('should add to external pause successfully', async () => {
      ...
      const result =
        await ExternalPausesManagement.setPausedMock(setPausedMockRequest);
      ...
      expect(commandBusMock.execute).toHaveBeenCalledWith(
        new SetPausedMockCommand(
          setPausedMockRequest.contractId,
          setPausedMockRequest.paused,
        ),
      );
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(
        ExternalPausesManagement.setPausedMock(setPausedMockRequest),
      ).rejects.toThrow('Command execution failed');
  ...
  describe('createMock', () => {
    ...
    it('should create external pause mock successfully', async () => {
      ...
      expect(commandBusMock.execute).toHaveBeenCalledWith(
        new CreateExternalPauseMockCommand(),
      );
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(ExternalPausesManagement.createMock()).rejects.toThrow(
  ...
  describe('isPausedMock', () => {
    ...
    it('should check if address is in external pause successfully', async () => {
      ...
      const result =
        await ExternalPausesManagement.isPausedMock(isPausedMockRequest);
      ...
      expect(queryBusMock.execute).toHaveBeenCalledWith(
        new IsPausedMockQuery(isPausedMockRequest.contractId),
      );
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(
        ExternalPausesManagement.isPausedMock(isPausedMockRequest),
      ).rejects.toThrow('Query execution failed');
