...
describe('Kyc', () => {
  ...
  describe('grantKyc', () => {
    ...
    it('should grant kyc successfully', async () => {
      ...
      expect(commandBusMock.execute).toHaveBeenCalledWith(
        new GrantKycCommand(
          grantKycRequest.securityId,
          grantKycRequest.targetId,
          grantKycRequest.vcBase64,
        ),
      );
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(Kyc.grantKyc(grantKycRequest)).rejects.toThrow(
  ...
  describe('revokeKyc', () => {
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(Kyc.revokeKyc(revokeKycRequest)).rejects.toThrow(
        'Command execution failed',
      );
  ...
  describe('getKycFor', () => {
    ...
    it('should get kyc for successfully', async () => {
      ...
      expect(queryBusMock.execute).toHaveBeenCalledWith(
        new GetKycForQuery(
          getKycForRequest.securityId,
          getKycForRequest.targetId,
        ),
      );
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(Kyc.getKycFor(getKycForRequest)).rejects.toThrow(
  ...
  describe('getKycAccountsCount', () => {
    ...
    it('should get kyc accounts count successfully', async () => {
      ...
      expect(queryBusMock.execute).toHaveBeenCalledTimes(1);
      expect(queryBusMock.execute).toHaveBeenCalledWith(
        new GetKycAccountsCountQuery(
          getKycAccountsCountRequest.securityId,
          getKycAccountsCountRequest.kycStatus,
        ),
      );
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(
        Kyc.getKycAccountsCount(getKycAccountsCountRequest),
  ...
  describe('getKycAccountsData', () => {
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(
        Kyc.getKycAccountsData(getKycAccountsDataRequest),
      ).rejects.toThrow('Query execution failed');
  ...
  describe('getKycStatusFor', () => {
    ...
    it('should get kyc status for successfully', async () => {
      ...
      expect(queryBusMock.execute).toHaveBeenCalledTimes(1);
      expect(queryBusMock.execute).toHaveBeenCalledWith(
        new GetKycStatusForQuery(
          getKycStatusForRequest.securityId,
          getKycStatusForRequest.targetId,
        ),
      );
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(Kyc.getKycStatusFor(getKycStatusForRequest)).rejects.toThrow(
        'Query execution failed',
      );
  ...
  describe('activateInternalKyc', () => {
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(
        Kyc.activateInternalKyc(activateInternalKycRequest),
  ...
  describe('deactivateInternalKyc', () => {
    ...
    it('should update deactivate internal kyc successfully', async () => {
      ...
      const result = await Kyc.deactivateInternalKyc(
        deactivateInternalKycRequest,
      );
      ...
      expect(commandBusMock.execute).toHaveBeenCalledWith(
        new DeactivateInternalKycCommand(
          deactivateInternalKycRequest.securityId,
        ),
      );
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(
        Kyc.deactivateInternalKyc(deactivateInternalKycRequest),
      ).rejects.toThrow('Command execution failed');
  ...
  describe('isInternalKycActivated', () => {
    ...
    it('should check if internal kyc is activated', async () => {
      ...
      const result = await Kyc.isInternalKycActivated(
        isInternalKycActivatedRequest,
      );
      ...
      expect(queryBusMock.execute).toHaveBeenCalledWith(
        new IsInternalKycActivatedQuery(
          isInternalKycActivatedRequest.securityId,
        ),
      );
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(
        Kyc.isInternalKycActivated(isInternalKycActivatedRequest),
      ).rejects.toThrow('Query execution failed');
