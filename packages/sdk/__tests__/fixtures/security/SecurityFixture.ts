...
export const GetTotalSecurityHoldersQueryFixture =
  createFixture<GetTotalSecurityHoldersQuery>((query) => {
    query.securityId.as(() => HederaIdPropsFixture.create().value);
  });

export const GetSecurityHoldersRequestFixture =
  createFixture<GetSecurityHoldersRequest>((request) => {
...
export const GetTotalSecurityHoldersRequestFixture =
  createFixture<GetTotalSecurityHoldersRequest>((request) => {
    request.securityId.as(() => HederaIdPropsFixture.create().value);
  });
