...
export const RemoveIssuerRequestFixture = createFixture<RemoveIssuerRequest>(
  (request) => {
    request.securityId.as(() => HederaIdPropsFixture.create().value);
    request.issuerId.as(() => HederaIdPropsFixture.create().value);
  },
...
export const GetRevocationRegistryAddressRequestFixture =
  createFixture<GetRevocationRegistryAddressRequest>((request) => {
    request.securityId.as(() => HederaIdPropsFixture.create().value);
  });

export const GetIssuerListCountRequestFixture =
  createFixture<GetIssuerListCountRequest>((request) => {
    request.securityId.as(() => HederaIdPropsFixture.create().value);
  });

export const GetIssuerListMembersRequestFixture =
  createFixture<GetIssuerListMembersRequest>((request) => {
    request.securityId.as(() => HederaIdPropsFixture.create().value);
    request.start.faker((faker) => faker.number.int({ min: 1, max: 10 }));
    request.end.faker((faker) => faker.number.int({ min: 1, max: 10 }));
  });

export const IsIssuerRequestFixture = createFixture<IsIssuerRequest>(
  (request) => {
    request.securityId.as(() => HederaIdPropsFixture.create().value);
    request.issuerId.as(() => HederaIdPropsFixture.create().value);
  },
