...
export const GetTokenHoldersAtSnapshotRequestFixture =
  createFixture<GetTokenHoldersAtSnapshotRequest>((request) => {
    request.securityId.as(() => HederaIdPropsFixture.create().value);
...
export const GetTotalTokenHoldersAtSnapshotRequestFixture =
  createFixture<GetTotalTokenHoldersAtSnapshotRequest>((request) => {
    request.securityId.as(() => HederaIdPropsFixture.create().value);
    request.snapshotId.faker((faker) => faker.number.int({ min: 1, max: 10 }));
  });
