...
export const ProtectedRedeemFromByPartitionRequestFixture =
  createFixture<ProtectedRedeemFromByPartitionRequest>((request) => {
    request.securityId.as(() => HederaIdPropsFixture.create().value);
    request.partitionId.as(() => PartitionIdFixture.create().value);
    request.sourceId.as(() => HederaIdPropsFixture.create().value);
    request.amount.faker((faker) =>
...
export const PartitionsProtectedRequestFixture =
  createFixture<PartitionsProtectedRequest>((request) => {
    request.securityId.as(() => HederaIdPropsFixture.create().value);
  });
